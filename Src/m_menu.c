...
{
    #ifdef RP
	{IT_CALL   | IT_STRING,0, "admin  tools", M_SecretsMenu, 92},
	#else
...
#ifdef RP
consvar_t cv_newgametype  = {"newgametype"  ,"0",CV_HIDEN,gametype_cons_t}; // Tails 01-18-2001
#else
...
void M_DrawSetupMultiPlayerMenu(void)
{
    ...
    if (--multi_tics<=0)
    {
        ...
        #ifdef RP
        if (st >= mobjinfo[MT_PLAYER].seestate+players[consoleplayer].aframes[AS_WALK]) // Only works for the consoleplayer and walking state, though... Damnit... ... ...
            multi_state = &states[mobjinfo[MT_PLAYER].seestate];
        else
        #endif
        if (st!=S_NULL)
    ...
    #ifdef RP
    sprdef    = &skins[R_SkinAvailable(setupm_cvskin->string)].sprwalk;
...
menuitem_t SecretsMenu[]=
{
    ...
    {IT_STRING | IT_CVAR,0,"Player Speed" ,&cv_playerspeed,10},
    #else
...
/*  {IT_CALL | IT_STRING2,0,"Fist/Chainsaw"  ,M_ChangeControl,gc_weapon1},
  ...
  #ifdef RP
  {IT_CALL | IT_STRING2,0,"RP Ability 1"   ,M_ChangeControl, gc_rp1     },
  {IT_CALL | IT_STRING2,0,"RP Ability 2"   ,M_ChangeControl, gc_rp2     },
  {IT_CALL | IT_STRING2,0,"RP Ability 3"   ,M_ChangeControl, gc_rp3     },
  {IT_CALL | IT_STRING2,0,"RP Ability 4"   ,M_ChangeControl, gc_rp4     },
  {IT_CALL | IT_STRING2,0,"RP Ability 5"   ,M_ChangeControl, gc_rp5     },
  {IT_CALL | IT_STRING2,0,"RP Ability 6"   ,M_ChangeControl, gc_rp6     },
  {IT_CALL | IT_STRING2,0,"RP Ability 7"   ,M_ChangeControl, gc_rp7     },
  /*{IT_CALL | IT_STRING2,0,"RP Lock"        ,M_ChangeControl, gc_rplock  },
  {IT_CALL | IT_STRING2,0,"RP Unlock"      ,M_ChangeControl, gc_rpunlock},*/
  #endif
...
#if NUMABILITYS > 7
#error REMEMBER TO ADD NEW BUTTON MENU SELECTION THINGIES FOR TEH RP ABILITYS!1!!!111!11!
#endif
