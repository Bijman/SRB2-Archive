...
// if higher translucency needed, toy around with the other tr_trans variables
    ...
    #ifdef RP
	R_SetTrans (S_SHIELD1, S_SHIELD8, tr_transmed);
    #else
    ...
    #ifdef RP
    R_SetTrans (S_SBUBBLE, 0, tr_transmed);
    R_SetTrans (S_MBUBBLE, 0, tr_transmed);
    R_SetTrans (S_HBUBBLE1, S_HBUBBLE3, tr_transmed);
    #else
