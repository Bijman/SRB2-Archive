...
int R_GetFlatNumForName(char *name)
{
  ...
  if(lump == -1)
  {
	...
	&& strcmp(name, "F_SKY9")
	#endif
	) // Ignore the F_SKY1 missing error Tails 05-06-2003
...
//            W_CacheLumpNum(lump, PU_CACHE);
    ...
    #ifdef MULTISKY
    texturepresent[sky2texture] = texturepresent[sky3texture] =
    texturepresent[sky4texture] = texturepresent[sky5texture] =
    texturepresent[sky6texture] = texturepresent[sky7texture] =
    texturepresent[sky8texture] = texturepresent[sky9texture] = 1;
    #endif
