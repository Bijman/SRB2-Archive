...
int R_DoorClosed(void)
{
  return
    ...
    && ((backsector->ceilingpic != skyflatnum
        ...
        && backsector->ceilingpic != sky3flatnum
        && backsector->ceilingpic != sky4flatnum
        && backsector->ceilingpic != sky5flatnum
        && backsector->ceilingpic != sky6flatnum
        && backsector->ceilingpic != sky7flatnum
        && backsector->ceilingpic != sky8flatnum
        && backsector->ceilingpic != sky9flatnum
        #endif
        ) || (frontsector->ceilingpic != skyflatnum
        #ifdef MULTISKY
        && frontsector->ceilingpic != sky2flatnum
        && frontsector->ceilingpic != sky3flatnum
        && frontsector->ceilingpic != sky4flatnum
        && frontsector->ceilingpic != sky5flatnum
        && frontsector->ceilingpic != sky6flatnum
        && frontsector->ceilingpic != sky7flatnum
        && frontsector->ceilingpic != sky8flatnum
        && frontsector->ceilingpic != sky9flatnum
        #endif
        ));
}
      ...
      if ((underwater && (tempsec->  floorheight = sec->floorheight,
        ...
        {                   // head-below-floor hack
          ...
          if (underwater)
            ...
            || s->ceilingpic == sky3flatnum
            || s->ceilingpic == sky4flatnum
            || s->ceilingpic == sky5flatnum
            || s->ceilingpic == sky6flatnum
            || s->ceilingpic == sky7flatnum
            || s->ceilingpic == sky8flatnum
            || s->ceilingpic == sky9flatnum
            #endif
            )
              {
        ...
        if (heightsec != -1 && viewz >= sectors[heightsec].ceilingheight &&
          ...
          {   // Above-ceiling hack
            ...
            && s->floorpic != sky3flatnum
            && s->floorpic != sky4flatnum
            && s->floorpic != sky5flatnum
            && s->floorpic != sky6flatnum
            && s->floorpic != sky7flatnum
            && s->floorpic != sky8flatnum
            && s->floorpic != sky9flatnum
            #endif
            )
              {
...
void R_Subsector (int num)
{
    ...
    if ((frontsector->floorheight < viewz || (frontsector->heightsec != -1 &&
        ...
        || sectors[frontsector->heightsec].ceilingpic == sky3flatnum
        || sectors[frontsector->heightsec].ceilingpic == sky4flatnum
        || sectors[frontsector->heightsec].ceilingpic == sky5flatnum
        || sectors[frontsector->heightsec].ceilingpic == sky6flatnum
        || sectors[frontsector->heightsec].ceilingpic == sky7flatnum
        || sectors[frontsector->heightsec].ceilingpic == sky8flatnum
        || sectors[frontsector->heightsec].ceilingpic == sky9flatnum
        #endif
        ))))
    {
    ...
    if ((frontsector->ceilingheight > viewz
        ...
        (frontsector->heightsec != -1 &&
         ...
         || sectors[frontsector->heightsec].floorpic == sky3flatnum
         || sectors[frontsector->heightsec].floorpic == sky4flatnum
         || sectors[frontsector->heightsec].floorpic == sky5flatnum
         || sectors[frontsector->heightsec].floorpic == sky6flatnum
         || sectors[frontsector->heightsec].floorpic == sky7flatnum
         || sectors[frontsector->heightsec].floorpic == sky8flatnum
         || sectors[frontsector->heightsec].floorpic == sky9flatnum
         #endif
         ))))
    {
