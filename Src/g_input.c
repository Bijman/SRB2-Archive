...
char *gamecontrolname[num_gamecontrols] =
{
	...
	#if NUMABILITYS > 7
	#error REMEMBER TO ADD NEW CONTROL NAMES FOR TEH NEW RP ABILITYS!1!11111!!1!!!!!
	#endif
...
void G_Controldefault(void)
{
    ...
    #ifdef RP
	gamecontrol[gc_rp1        ][0]='1';
	gamecontrol[gc_rp2        ][0]='2';
	gamecontrol[gc_rp3        ][0]='3';
	gamecontrol[gc_rp4        ][0]='4';
	gamecontrol[gc_rp5        ][0]='5';
	gamecontrol[gc_rp6        ][0]='6';
	gamecontrol[gc_rp7        ][0]='7';
	/*gamecontrol[gc_rplock     ][0]='l';
	gamecontrol[gc_rpunlock   ][0]='k';*/

	#if NUMABILITYS > 7
	#error REMEMBER TO ADD NEW GAME CONTROL DEFAULT KEYS FOR TEH NEW RP ABILITYS!1!11111!!1!!!!!
	#endif
