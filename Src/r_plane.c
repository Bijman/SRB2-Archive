...
void R_DrawPlanes (void)
{
    ...
    for (pl=visplanes[i]; pl; pl=pl->next)
    {
        ...
        // sky flat
        if (pl->picnum == skyflatnum) // MULTISKY stuff below.
        {
