...
//
    ...
    #ifdef MARIO
    {SPR_PLAY,0,105,{NULL},S_NULL},  // S_PLAY_STND // Tails 9-28-99 stand
    {SPR_PLAY,3,4,{NULL},S_PLAY_RUN2},      // S_PLAY_RUN1
    {SPR_PLAY,4,4,{NULL},S_PLAY_RUN3},      // S_PLAY_RUN2
    {SPR_PLAY,5,4,{NULL},S_NULL},      // S_PLAY_RUN3
    {SPR_PLAY,11,1,{NULL},S_NULL},  // S_PLAY_ATK1 // Tails 9-14-99
    ...
    {SPR_PLAY,27,-1,{NULL},S_PLAY_STND},     // S_PLAY_PAIN2
    {SPR_PLAY,27,-1,{NULL},S_PLAY_STND},     // S_PLAY_PAIN3
    {SPR_PLAY,27,-1,{NULL},S_PLAY_STND},     // S_PLAY_PAIN4
    {SPR_PLAY,27,-1,{NULL},S_PLAY_STND},     // S_PLAY_PAIN5
    {SPR_PLAY,27,-1,{NULL},S_PLAY_STND},     // S_PLAY_PAIN6
    {SPR_PLAY,27,-1,{NULL},S_PLAY_STND},     // S_PLAY_PAIN7
    {SPR_PLAY,27,-1,{NULL},S_PLAY_STND},     // S_PLAY_PAIN8
    {SPR_PLAY,27,-1,{NULL},S_PLAY_STND},     // S_PLAY_PAIN9
...
///////////////////////////
    ...
    {			// MT_TELEPORTMAN - for teleport effect Graue 11-05-2003
      ...
      sfx_None,       // activesound                              
      #ifdef RP
      MF_NOBLOCKMAP|MF_NOGRAVITY,  // flags: do not set MF_NOSECTOR, please Graue 12-12-2003
      #else
      MF_NOBLOCKMAP,  // flags: do not set MF_NOSECTOR, please Graue 12-12-2003
      #endif
      S_NULL          // raisestate                                   
