...
// Une erreur s'y �ait gliss� d'o un segfault si on compilait sans SDL.
//
						  ...
						  sfxinfo_t*    sfxinfo) // Handy! Tails 10-08-2002
{
	...
	if(sfxinfo->pitch == 43) // Rain special case
	{
		...
		#ifdef MULTISKY
		|| listener->subsector->sector->ceilingpic == sky2flatnum
		|| listener->subsector->sector->ceilingpic == sky3flatnum
		|| listener->subsector->sector->ceilingpic == sky4flatnum
		|| listener->subsector->sector->ceilingpic == sky5flatnum
		|| listener->subsector->sector->ceilingpic == sky6flatnum
		|| listener->subsector->sector->ceilingpic == sky7flatnum
		|| listener->subsector->sector->ceilingpic == sky8flatnum
		|| listener->subsector->sector->ceilingpic == sky9flatnum
		#endif
		)
			approx_dist = 0;
		else
