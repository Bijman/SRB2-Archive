...
typedef struct player_s
{
	...
	#ifdef RP
    astate_t astate; // Active player state! ^_^ Aka. "Which animation is playing?!" in one variable.
    byte aframes[NUMASTATES]; // Number of frames in each "state"
    #else
	...
	boolean blackow; // Tails 01-11-2001
	...
	short trigger; // Which sector you last triggered
	boolean intercom; // Are you near an intercom?
	char* card;
	byte cardtime;
	#endif
