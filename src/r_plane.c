...
void R_DrawPlanes (void)
{
	...
	|| pl->picnum == sky2flatnum
	|| pl->picnum == sky3flatnum
	|| pl->picnum == sky4flatnum
	|| pl->picnum == sky5flatnum
	|| pl->picnum == sky6flatnum
	|| pl->picnum == sky7flatnum
	|| pl->picnum == sky8flatnum
	|| pl->picnum == sky9flatnum)
        {
...
// centery = (viewheight/2);
	    ...
	    else if(pl->picnum == sky2flatnum)
            	dc_texturemid = sky2texturemid;
	    else if(pl->picnum == sky3flatnum)
            	dc_texturemid = sky3texturemid;
	    else if(pl->picnum == sky4flatnum)
            	dc_texturemid = sky4texturemid;
	    else if(pl->picnum == sky5flatnum)
            	dc_texturemid = sky5texturemid;
	    else if(pl->picnum == sky6flatnum)
            	dc_texturemid = sky6texturemid;
	    else if(pl->picnum == sky7flatnum)
            	dc_texturemid = sky7texturemid;
	    else if(pl->picnum == sky8flatnum)
            	dc_texturemid = sky8texturemid;
	    else if(pl->picnum == sky9flatnum)
            	dc_texturemid = sky9texturemid;

	    if (pl->picnum == skyflatnum)
            	dc_texheight = textureheight[skytexture] >> FRACBITS;
	    else if(pl->picnum == sky2flatnum)
            	dc_texheight = textureheight[sky2texture] >> FRACBITS;
	    else if(pl->picnum == sky3flatnum)
            	dc_texheight = textureheight[sky3texture] >> FRACBITS;
	    else if(pl->picnum == sky4flatnum)
            	dc_texheight = textureheight[sky4texture] >> FRACBITS;
	    else if(pl->picnum == sky5flatnum)
            	dc_texheight = textureheight[sky5texture] >> FRACBITS;
	    else if(pl->picnum == sky6flatnum)
            	dc_texheight = textureheight[sky6texture] >> FRACBITS;
	    else if(pl->picnum == sky7flatnum)
            	dc_texheight = textureheight[sky7texture] >> FRACBITS;
	    else if(pl->picnum == sky8flatnum)
            	dc_texheight = textureheight[sky8texture] >> FRACBITS;
	    else if(pl->picnum == sky9flatnum)
            	dc_texheight = textureheight[sky9texture] >> FRACBITS;
		    ...
		    if(pl->picnum == skyflatnum)
                    	...
                    	dc_source = R_GetColumn(sky2texture, angle);
		    else if(pl->picnum == sky3flatnum)
                    	dc_source = R_GetColumn(sky3texture, angle);
		    else if(pl->picnum == sky4flatnum)
                    	dc_source = R_GetColumn(sky4texture, angle);
		    else if(pl->picnum == sky5flatnum)
                    	dc_source = R_GetColumn(sky5texture, angle);
		    else if(pl->picnum == sky6flatnum)
                    	dc_source = R_GetColumn(sky6texture, angle);
		    else if(pl->picnum == sky7flatnum)
                    	dc_source = R_GetColumn(sky7texture, angle);
		    else if(pl->picnum == sky8flatnum)
                    	dc_source = R_GetColumn(sky8texture, angle);
		    else if(pl->picnum == sky9flatnum)
                    	dc_source = R_GetColumn(sky9texture, angle);
