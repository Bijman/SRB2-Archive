...
mobjinfo_t mobjinfo[NUMMOBJTYPES] =
{
	...
	{           // MT_VIRTUALPLAYER
		...
		99,             // reactiontime
		sfx_thok,       // attacksound
		S_PLAY_PAIN,    // painstate  // Don't change the player's states
		MT_THOK,        // painchance
		sfx_None,       // painsound
		S_NULL,         // meleestate
		S_PLAY_ATK1,    // missilestate
		...
		S_PLAY_DIE1,    // xdeathstate
		sfx_None,       // deathsound
		1,              // speed // Distance between each burst to check for other players
		16*FRACUNIT,    // radius
		56*FRACUNIT,    // height
		0,              // display offset
		100,            // mass // LXShadow changed this
		MT_THOK,        // damage
		sfx_None,       // activesound
		MF_TRANSLATION|MF_NOTHINK|MF_SHOOTABLE, // flags // Removed MF_SOLID
		MT_THOK          // raisestate
	},
#endif
};
