...
{
#ifdef RIDERS
	"RIDR","POSS","SPOS","FISH","BUZZ","RBUZ","JETB","JETG","CCOM","DETN",
#else
...
state_t states[NUMSTATES] =
{
	...
	// Player
#ifdef RIDERS
	{SPR_RIDR,     0, 105, {NULL},   0, 0, S_RIDR_TAP1},        // S_RIDR_STND
	{SPR_RIDR,     1,  16, {NULL},   0, 0, S_RIDR_TAP2},        // S_RIDR_TAP1
	{SPR_RIDR,     2,  16, {NULL},   0, 0, S_RIDR_TAP1},        // S_RIDR_TAP2
	{SPR_RIDR,     3,   4, {NULL},   0, 0, S_RIDR_RUN2},        // S_RIDR_RUN1
	{SPR_RIDR,     4,   4, {NULL},   0, 0, S_RIDR_RUN3},        // S_RIDR_RUN2
	{SPR_RIDR,     5,   4, {NULL},   0, 0, S_RIDR_RUN4},        // S_RIDR_RUN3
	{SPR_RIDR,     6,   4, {NULL},   0, 0, S_RIDR_RUN1},        // S_RIDR_RUN4
	{SPR_RIDR,     7,   4, {NULL},   0, 0, S_RIDR_RUN6},        // S_RIDR_RUN5
	{SPR_RIDR,     8,   4, {NULL},   0, 0, S_RIDR_RUN7},        // S_RIDR_RUN6
	{SPR_RIDR,     9,   4, {NULL},   0, 0, S_RIDR_RUN8},        // S_RIDR_RUN7
	{SPR_RIDR,    10,   4, {NULL},   0, 0, S_RIDR_RUN1},        // S_RIDR_RUN8
	{SPR_RIDR,    11,   1, {NULL},   0, 0, S_RIDR_ATK2},        // S_RIDR_ATK1
	{SPR_RIDR,    12,   1, {NULL},   0, 0, S_RIDR_ATK3},        // S_RIDR_ATK2
	{SPR_RIDR,    13,   1, {NULL},   0, 0, S_RIDR_ATK4},        // S_RIDR_ATK3
	{SPR_RIDR,    14,   1, {NULL},   0, 0, S_RIDR_ATK1},        // S_RIDR_ATK4
	{SPR_RIDR,    15,  -1, {NULL},   0, 0, S_NULL},             // S_RIDR_PLG1
	{SPR_RIDR,    16,   2, {NULL},   0, 0, S_RIDR_SPD2},        // S_RIDR_SPD1
	{SPR_RIDR,    17,   2, {NULL},   0, 0, S_RIDR_SPD3},        // S_RIDR_SPD2
	{SPR_RIDR,    18,   2, {NULL},   0, 0, S_RIDR_SPD4},        // S_RIDR_SPD3
	{SPR_RIDR,    19,   2, {NULL},   0, 0, S_RIDR_SPD1},        // S_RIDR_SPD4
	{SPR_RIDR,    20,   2, {NULL},   0, 0, S_RIDR_ABL2},        // S_RIDR_ABL1
	{SPR_RIDR,    21,   2, {NULL},   0, 0, S_RIDR_ABL1},        // S_RIDR_ABL2
	{SPR_RIDR,    22,   6, {NULL},   0, 0, S_RIDR_SPC2},        // S_RIDR_SPC1
	{SPR_RIDR,    23,   6, {NULL},   0, 0, S_RIDR_SPC3},        // S_RIDR_SPC2
	{SPR_RIDR,    24,   6, {NULL},   0, 0, S_RIDR_SPC4},        // S_RIDR_SPC3
	{SPR_RIDR,    25,   6, {NULL},   0, 0, S_RIDR_SPC1},        // S_RIDR_SPC4
	{SPR_RIDR,    22,  -1, {NULL},   0, 0, S_NULL},             // S_RIDR_CLIMB1
	{SPR_RIDR,    23,   5, {NULL},   0, 0, S_RIDR_CLIMB3},      // S_RIDR_CLIMB2
	{SPR_RIDR,    24,   5, {NULL},   0, 0, S_RIDR_CLIMB4},      // S_RIDR_CLIMB3
	{SPR_RIDR,    25,   5, {NULL},   0, 0, S_RIDR_CLIMB5},      // S_RIDR_CLIMB4
	{SPR_RIDR,    24,   5, {NULL},   0, 0, S_RIDR_CLIMB2},      // S_RIDR_CLIMB5
	{SPR_RIDR,    26,  14, {NULL},   0, 0, S_RIDR_RUN1},        // S_RIDR_GASP
	{SPR_RIDR,    27,  -1, {NULL},   0, 0, S_RIDR_STND},        // S_RIDR_PAIN
	{SPR_RIDR,    28,   8, {A_Fall}, 0, 0, S_RIDR_DIE2},        // S_RIDR_DIE1
	{SPR_RIDR,    28,   7, {NULL},   0, 0, S_RIDR_DIE3},        // S_RIDR_DIE2
	{SPR_RIDR,    28,  -1, {NULL},   0, 0, S_NULL},             // S_RIDR_DIE3
	{SPR_RIDR,    29,  12, {NULL},   0, 0, S_RIDR_TEETER2},     // S_RIDR_TEETER1
	{SPR_RIDR,    30,  12, {NULL},   0, 0, S_RIDR_TEETER1},     // S_RIDR_TEETER2
	{SPR_RIDR,    31,   2, {NULL},   0, 0, S_RIDR_FALL2},       // S_RIDR_FALL1
	{SPR_RIDR,    32,   2, {NULL},   0, 0, S_RIDR_FALL1},       // S_RIDR_FALL2
	{SPR_RIDR,    33,  -1, {NULL},   0, 0, S_NULL},             // S_RIDR_CARRY
	{SPR_RIDR,    20,  -1, {NULL},   0, 0, S_RIDR_SUPERSTAND},  // S_RIDR_SUPERSTAND
	{SPR_RIDR,    20,   7, {NULL},   0, 0, S_RIDR_SUPERWALK2},  // S_RIDR_SUPERWALK1
	{SPR_RIDR,    21,   7, {NULL},   0, 0, S_RIDR_SUPERWALK1},  // S_RIDR_SUPERWALK2
	{SPR_RIDR,    22,   7, {NULL},   0, 0, S_RIDR_SUPERFLY2},   // S_RIDR_SUPERFLY1
	{SPR_RIDR,    23,   7, {NULL},   0, 0, S_RIDR_SUPERFLY1},   // S_RIDR_SUPERFLY2
	{SPR_RIDR,    24,  12, {NULL},   0, 0, S_RIDR_SUPERTEETER}, // S_RIDR_SUPERTEETER
	{SPR_RIDR,    25,  -1, {NULL},   0, 0, S_RIDR_SUPERSTAND},  // S_RIDR_SUPERHIT
	{SPR_RIDR,    38,   4, {NULL},   0, 0, S_PLAY_SUPERTRANS2}, // S_PLAY_SUPERTRANS1
	{SPR_RIDR,    39,   4, {NULL},   0, 0, S_PLAY_SUPERTRANS3}, // S_PLAY_SUPERTRANS2
	{SPR_RIDR, 32808,   4, {NULL},   0, 0, S_PLAY_SUPERTRANS4}, // S_PLAY_SUPERTRANS3
	{SPR_RIDR,    41,   3, {NULL},   0, 0, S_PLAY_SUPERTRANS5}, // S_PLAY_SUPERTRANS4
	{SPR_RIDR,    42,   3, {NULL},   0, 0, S_PLAY_SUPERTRANS6}, // S_PLAY_SUPERTRANS5
	{SPR_RIDR,    43,   3, {NULL},   0, 0, S_PLAY_SUPERTRANS7}, // S_PLAY_SUPERTRANS6
	{SPR_RIDR,    44,   3, {NULL},   0, 0, S_PLAY_SUPERTRANS8}, // S_PLAY_SUPERTRANS7
	{SPR_RIDR,    45,   3, {NULL},   0, 0, S_PLAY_SUPERTRANS9}, // S_PLAY_SUPERTRANS8
	{SPR_RIDR,    46,  16, {NULL},   0, 0, S_RIDR_RUN1},        // S_PLAY_SUPERTRANS9

	// 1-Up Box Sprites (uses player sprite)
	{SPR_RIDR, 77, 2, {A_1upThinker}, 0, 0, S_PLAY_BOX1B}, // S_PLAY_BOX1A
	{SPR_RIDR, 78, 2, {NULL}, 0, 0, S_PLAY_BOX1A},         // S_PLAY_BOX1B
	{SPR_RIDR, 79, 18, {NULL}, 0, 0, S_PLAY_BOX1D},        // S_PLAY_BOX1C
	{SPR_RIDR, 79, 18, {A_ExtraLife}, 0, 0, S_NULL},       // S_PLAY_BOX1D

	// Level end sign (uses player sprite)
	{SPR_RIDR, 80, -1, {NULL}, 0, 0, S_NULL},         // S_PLAY_SIGN
#else
	...
	// Crawla Commander
	{SPR_CCOM, 0, 1, {NULL}, 0, 0, S_RANDOMITEM33}, // S_CCOMMAND1
	{SPR_CCOM, 1, 1, {NULL}, 0, 0, S_RANDOMITEM33}, // S_CCOMMAND2
	{SPR_CCOM, 2, 1, {NULL}, 0, 0, S_RANDOMITEM33}, // S_CCOMMAND3
	{SPR_CCOM, 3, 1, {NULL}, 0, 0, S_RANDOMITEM33}, // S_CCOMMAND4
	...
	{SPR_FBLL, 32769, 3, {NULL}, 0, 0, S_FIREBALL2},    // S_FIREBALL1
	{SPR_FBLL, 32770, 3, {NULL}, 0, 0, S_FIREBALL3},    // S_FIREBALL2
	{SPR_FBLL, 32771, 3, {NULL}, 0, 0, S_FIREBALL4},    // S_FIREBALL3
	{SPR_FBLL, 32772, 3, {NULL}, 0, 0, S_FIREBALL5},    // S_FIREBALL4
	{SPR_FBLL, 32773, 3, {NULL}, 0, 0, S_FIREBALL6},    // S_FIREBALL5
	{SPR_FBLL, 32774, 3, {NULL}, 0, 0, S_FIREBALL7},    // S_FIREBALL6
	{SPR_FBLL, 32775, 3, {NULL}, 0, 0, S_FIREBALL1},    // S_FIREBALL7
	{SPR_FBLL, 32776, 3, {NULL}, 0, 0, S_FIREBALLEXP2}, // S_FIREBALLEXP1
	{SPR_FBLL, 32777, 3, {NULL}, 0, 0, S_FIREBALLEXP3}, // S_FIREBALLEXP2
	{SPR_FBLL, 32778, 3, {NULL}, 0, 0, S_FIREBALLEXP4}, // S_FIREBALLEXP3
	{SPR_FBLL, 32779, 3, {NULL}, 0, 0, S_FIREBALLEXP5}, // S_FIREBALLEXP4
	{SPR_FBLL, 32780, 3, {NULL}, 0, 0, S_FIREBALLEXP6}, // S_FIREBALLEXP5
	{SPR_FBLL, 32781, 3, {NULL}, 0, 0, S_NULL},         // S_FIREBALLEXP6
	...
	{SPR_SHLL, 3, 2, {NULL}, 0, 0, S_SHELL5}, // S_SHELL4
	{SPR_SHLL, 4, 2, {NULL}, 0, 0, S_SHELL6}, // S_SHELL5
	{SPR_SHLL, 5, 2, {NULL}, 0, 0, S_SHELL7}, // S_SHELL6
	{SPR_SHLL, 6, 2, {NULL}, 0, 0, S_SHELL8}, // S_SHELL7
	{SPR_SHLL, 7, 2, {NULL}, 0, 0, S_SHELL1}, // S_SHELL8
...
mobjinfo_t mobjinfo[NUMMOBJTYPES] =
{
	...
	{           // MT_CRAWLACOMMANDER
		...
		0,              // damage
		0,              // activesound
		MF_SLIDEME|MF_SPECIAL|MF_SHOOTABLE, // flags
		S_NULL          // raisestate
	},
	...
	{           // MT_SPINFIRE
		...
		1,              // damage
		sfx_None,       // activesound
		MF_NOBLOCKMAP|MF_NOGRAVITY|MF_MISSILE|MF_FIRE, // flags
		S_NULL          // raisestate
	},
	...
	{           // MT_COIN
		...
		0,              // damage
		sfx_None,       // activesound
		MF_SCENERY|MF_NOGRAVITY, // flags MF_SLIDEME|MF_SPECIAL|MF_NOGRAVITY
		S_NULL          // raisestate
	},
