...
static INT16 Wins = 0; // wins
static INT16 Loses = 0; // wins obviously
...
static void M_CustomPlayerSelect(void);
...
menu_t OP_CrateMonitorToggleDef;
...
static void M_DDrawMonitorToggles(void);
#ifdef HWRENDER
...
consvar_t cv_newgametype = {"newgametype", "Brawl", CV_HIDEN|CV_CALL, gametype_cons_t, Newgametype_OnChange, 0, NULL, NULL, 0, 0, NULL};
...
static CV_PossibleValue_t dummyteam_cons_t[] = {{0, "All"}, {1, "Bomb"}, {2, "Pumpkin"}, {3, "Hamburger"}, {4, "Spikeball"}, {5, "Heart"}, {6, "Mine"}, {7, "Crate"}, {8, "Super Emerald"}, {0, NULL}};
static CV_PossibleValue_t dummyscramble_cons_t[] = {{0, "Points"}, {1, "Stock"}, {0, NULL}};
static CV_PossibleValue_t ddummyscramble_cons_t[] = {{0, "Points"}, {1, "Stock"}, {0, NULL}};
...
consvar_t cv_dummyteam = {"itemslist", "All", CV_NETVAR, dummyteam_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_dummyscramble = {"donotusethis", "Points", CV_NETVAR, dummyscramble_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_setgamemodebefore = {"gamemode", "Points", CV_NETVAR, ddummyscramble_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
...
{
	{IT_CALL   |IT_STRING, NULL, "online shortcut",    M_ConnectMenu,      92},
	{IT_CALL   |IT_STRING, NULL, "adventure mode",   M_SinglePlayerMenu, 84},
	{IT_SUBMENU|IT_STRING, NULL, "free-for-all", &MP_MainDef,       100},
...
{
	{IT_STRING|IT_CVAR,              NULL, "Map",                 &cv_nextmap,        60},
   
	{IT_WHITESTRING|IT_CALL,         NULL, "Go!",                 M_LevelSelectWarp,     120},
...
{
	{IT_KEYHANDLER | IT_NOTHING, NULL, "WINS:", M_HandleGameStats, '\0'},     // dummy menuitem for the control func
};

static menuitem_t SP_LevelStatsMenu[] =
{
	{IT_KEYHANDLER | IT_NOTHING, NULL, "LOSES:", M_HandleLevelStats, '\0'},     // dummy menuitem for the control func
};
...
static menuitem_t MP_MainMenu[] =
{
	...
	{IT_CALL | IT_STRING, NULL, "HOST ROOM",              M_StartServerMenu,      20},
	{IT_CALL | IT_STRING, NULL, "JOIN ROOM",	  M_ConnectMenu,		  40},
	{IT_CALL | IT_STRING, NULL, "JOIN IP", M_ConnectIPMenu,        50},
#endif
	{IT_CALL | IT_STRING, NULL, "TWO PLAYERS MODE",        M_StartSplitServerMenu, 70},
...
#ifndef NONET
	{IT_STRING|IT_CALL,              NULL, "Room...",               M_RoomMenu,         40},
	{IT_STRING|IT_CVAR|IT_CV_STRING, NULL, "Server Name",           &cv_servername,     50},
#endif

	{IT_STRING|IT_CVAR,              NULL, "Map",                 &cv_nextmap,        80},
		
	{IT_WHITESTRING|IT_CALL,         NULL, "Go!",                 M_StartServer,     130},
...
{
	{IT_STRING|IT_CVAR,              NULL, "Game Type",             &cv_newgametype,    20},
	{IT_STRING|IT_CVAR,              NULL, "Map",                 &cv_nextmap,        80},
	{IT_WHITESTRING|IT_CALL,         NULL, "Go!",                 M_StartServer,     130},
};
...
static menuitem_t MP_PlayerSetupMenu[] =
{
	...
	{IT_KEYHANDLER | IT_STRING,   NULL, "Player", M_HandleSetupMultiPlayer,  96}, // Tails 01-18-2001
};
...
static menuitem_t OP_MPControlsMenu[] =
{
	...
	{IT_CALL | IT_STRING2, NULL, "Pick Item",        M_ChangeControl, gc_tossflag     },
	...
	{IT_CALL | IT_STRING2, NULL, "Taunt",    M_ChangeControl, gc_wepslot1     },
	...
	{IT_CALL | IT_STRING2, NULL, "'A' Button",        M_ChangeControl, gc_fire         },
	{IT_CALL | IT_STRING2, NULL, "Shield/Dodge", M_ChangeControl, gc_firenormal   },
};
...
static menuitem_t OP_VideoOptionsMenu[] =
{
    ...
    {IT_STRING | IT_CVAR,    NULL, "Show Ping Bar",            &cv_pingrate,    100},
...
static menuitem_t OP_GameOptionsMenu[] =
{
	...
	{IT_STRING | IT_CVAR, NULL, "Brawl HUD Option",        &cv_hudoption,    130},
...
{
	{IT_STRING | IT_SUBMENU, NULL, "Skin options...",  &OP_NetgameOptionsDef,  10},
	{IT_STRING | IT_SUBMENU, NULL, "Basic options...",         &OP_GametypeOptionsDef, 20},
	{IT_STRING | IT_SUBMENU, NULL, "Items list...",   &OP_MonitorToggleDef,   30},
	{IT_STRING | IT_SUBMENU, NULL, "Crate Items list...",   &OP_CrateMonitorToggleDef,   40},
...
static menuitem_t OP_NetgameOptionsMenu[] =
{
	...
	{IT_STRING | IT_CVAR, NULL, "Force Skin #",          &cv_forceskin,          34},
	{IT_STRING | IT_CVAR, NULL, "Restrict skin changes", &cv_restrictskinchange, 42},
...
static menuitem_t OP_GametypeOptionsMenu[] =
{
	...
	{IT_HEADER,           NULL, "BRAWL",           NULL,                 34},
	{IT_STRING | IT_CVAR, NULL, "Items",            &cv_itemrespawn, 42},
	//{IT_STRING | IT_CVAR, NULL, "Items List",        &cv_dummyteam,    50},
	{IT_STRING | IT_CVAR, NULL, "Time Limit",            &cv_timelimit,        50},
	{IT_STRING | IT_CVAR, NULL, "Point Limit",           &cv_pointlimit,       58},
	{IT_STRING | IT_CVAR, NULL, "Stock Num",           &cv_stocklives,       66},
	{IT_STRING | IT_CVAR, NULL, "Game Mode",           &cv_setgamemodebefore,       74},
	{IT_STRING | IT_CVAR, NULL, "Sudden Death",           &cv_overtime,       82},
	{IT_STRING | IT_CVAR, NULL, "Teams",           &cv_triggerteams,       90},
	{IT_STRING | IT_CVAR, NULL, "Friendly Fire",           &cv_friendlyfire,       98},
...
static menuitem_t OP_MonitorToggleMenu[] =
{
	...
	{IT_STRING|IT_CVAR|IT_CV_INVISSLIDER, NULL, "Bomb",          &cv_recycler,      20},
	{IT_STRING|IT_CVAR|IT_CV_INVISSLIDER, NULL, "Hamburger",       &cv_teleporters,   30},
	{IT_STRING|IT_CVAR|IT_CV_INVISSLIDER, NULL, "Pumpkin",        &cv_superring,     40},
	{IT_STRING|IT_CVAR|IT_CV_INVISSLIDER, NULL, "Spikeball",    &cv_supersneakers, 50},
	{IT_STRING|IT_CVAR|IT_CV_INVISSLIDER, NULL, "Mine",     &cv_invincibility, 60},
	{IT_STRING|IT_CVAR|IT_CV_INVISSLIDER, NULL, "Heart",       &cv_jumpshield,    70},
	{IT_STRING|IT_CVAR|IT_CV_INVISSLIDER, NULL, "Crate",  &cv_watershield,   80},
	{IT_STRING|IT_CVAR|IT_CV_INVISSLIDER, NULL, "Super Emerald", &cv_ringshield,    90},
};

static menuitem_t OP_CrateMonitorToggleMenu[] =
{
	// Printing handled by drawing function
	{IT_STRING|IT_CVAR|IT_CV_INVISSLIDER, NULL, "Bomb",          &cv_arecycler,      20},
	{IT_STRING|IT_CVAR|IT_CV_INVISSLIDER, NULL, "Hamburger",       &cv_ateleporters,   30},
	{IT_STRING|IT_CVAR|IT_CV_INVISSLIDER, NULL, "Pumpkin",        &cv_asuperring,     40},
	{IT_STRING|IT_CVAR|IT_CV_INVISSLIDER, NULL, "Spikeball",    &cv_asupersneakers, 50},
	{IT_STRING|IT_CVAR|IT_CV_INVISSLIDER, NULL, "Mine",     &cv_ainvincibility, 60},
	{IT_STRING|IT_CVAR|IT_CV_INVISSLIDER, NULL, "Heart",       &cv_ajumpshield,    70},
	{IT_STRING|IT_CVAR|IT_CV_INVISSLIDER, NULL, "Nothing",  &cv_forceshield,   80},
	{IT_STRING|IT_CVAR|IT_CV_INVISSLIDER, NULL, "Super Emerald", &cv_aringshield,    90},
};
...
{
	"M_SERVER",
	sizeof (OP_CrateMonitorToggleMenu)/sizeof (menuitem_t),
	&OP_ServerOptionsDef,
	OP_CrateMonitorToggleMenu,
	M_DDrawMonitorToggles,
	30, 30,
	0,
	NULL
};
	...
	switch (ch)
	{
		...
		case KEY_ENTER:
			...
			if (routine)
			{
				...
				if (currentMenu == &MP_MainDef)
				{
				S_StartSound(NULL, sfx_ffa);
			    }
				if (currentMenu == &SP_MainDef)
				{
				S_StartSound(NULL, sfx_cmod);
			    }
				if (currentMenu != &MP_MainDef && currentMenu != &SP_MainDef)
				{
				S_StartSound(NULL, sfx_menu1);
			    }
...
void M_Drawer(void)
{
	...
	if (menuactive)
	{
		...
		if (currentMenu == &MainDef)
		{
			...
			{
				V_DrawThinString(vid.dupx, vid.height - 17*vid.dupy, V_NOSCALESTART|V_TRANSLUCENT, "Sonic Smash Brawl");
...
void M_Init(void)
{
	...
	CV_RegisterVar(&cv_setgamemodebefore);

	quitmsg[QUITMSG] = M_GetText("GAME OVER.       \n\n(Press 'Y' to quit)");
	quitmsg[QUITMSG1] = M_GetText("But... Life is gay!\n\n(Press 'Y' to quit)");
	quitmsg[QUITMSG2] = M_GetText("Are you sure about that?\n\n(Press 'Y' to quit)");
	quitmsg[QUITMSG3] = M_GetText("0/10.\n\n(Press 'Y' to quit)");
	quitmsg[QUITMSG4] = M_GetText("Loading ragequit.\n\n(Press 'Y' to quit)");
	quitmsg[QUITMSG5] = M_GetText("no.\n\n(Press 'Y' to quit)");
	quitmsg[QUITMSG6] = M_GetText("y u do dis.\n\n(Press 'Y' to quit)");
	quitmsg[QUITMSG7] = M_GetText("N.. nnnnnnn.\n\n(Press 'Y' to quit)");

	quitmsg[QUIT2MSG] = M_GetText("0/10.\n\n(Press 'Y' to quit)");
	quitmsg[QUIT2MSG1] = M_GetText("Loading ragequit.\n\n(Press 'Y' to quit)");
	quitmsg[QUIT2MSG2] = M_GetText("N.. nnnnnnn.\n\n(Press 'Y' to quit)");
	quitmsg[QUIT2MSG3] = M_GetText("y u do dis.\n\n(Press 'Y' to quit)");
	quitmsg[QUIT2MSG4] = M_GetText("no.\n\n(Press 'Y' to quit)");
	quitmsg[QUIT2MSG5] = M_GetText("0/10.\n\n(Press 'Y' to quit)");
	quitmsg[QUIT2MSG6] = M_GetText("Loading ragequit.\n\n(Press 'Y' to quit)");

	quitmsg[QUIT3MSG] = M_GetText("GAME OVER.       \n\n(Press 'Y' to quit)");
	quitmsg[QUIT3MSG1] = M_GetText("Loading ragequit.\n\n(Press 'Y' to quit)");
	quitmsg[QUIT3MSG2] = M_GetText("GAME OVER.       \n\n(Press 'Y' to quit)");
	quitmsg[QUIT3MSG3] = M_GetText("N.. nnnnnnn.\n\n(Press 'Y' to quit)");
	quitmsg[QUIT3MSG4] = M_GetText("Loading ragequit.\n\n(Press 'Y' to quit)");
	quitmsg[QUIT3MSG5] = M_GetText("GAME OVER.       \n\n(Press 'Y' to quit)");
	quitmsg[QUIT3MSG6] = M_GetText("no.\n\n(Press 'Y' to quit)");
	...
	if (!netgame && !multiplayer && (gamestate == GS_LEVEL || gamestate == GS_INTERMISSION))
	{
		...
		for (i = 0; i < 3; ++i)
		{
			...
			switch (emblem->type)
			{
				case ET_SCORE:
				case ET_NGRADE:
					V_DrawString(56, 44 + (i*8), V_YELLOWMAP, "WINS:");
					break;
				case ET_TIME:
				case ET_NTIME:
					V_DrawString(56, 44 + (i*8), V_YELLOWMAP, "LOSES:");
					break;
				//case ET_RINGS:
...
static void M_CustomPlayerSelect(void)
{
	...
	CV_SetValue(&cv_newgametype, GT_COMPETITION);
	
	CV_SetValue(&cv_nextmap, 195);
...
static void M_Statistics(INT32 choice)
{
	...
	SP_GameStatsDef.prevMenu = currentMenu;
...
static void M_DrawGameStats(void)
{
	...
	M_DrawMenuTitle();
	//V_DrawCenteredString(BASEVIDWIDTH/2, 24, V_YELLOWMAP, "PAGE 1 OF 1");
	...
	V_DrawCenteredString(BASEVIDWIDTH/2, 90, V_REDMAP, "* WORK IN PROGRESS MENU *");

	sprintf(beststr, "%u", bestscore);
	V_DrawString(32, 100, V_YELLOWMAP, "WINS:");
	//V_DrawRightAlignedString(BASEVIDWIDTH-32, 100, 0, beststr);
	V_DrawRightAlignedString(BASEVIDWIDTH-32, 100, 0, "???");
	if (mapsunfinished[0])
	...
	V_DrawString(32, 120, V_YELLOWMAP, "LOSES:");
	//V_DrawRightAlignedString(BASEVIDWIDTH-32, 120, 0, beststr);
	V_DrawRightAlignedString(BASEVIDWIDTH-32, 120, 0, "???");
	if (mapsunfinished[1])
...
static void M_Refresh(INT32 choice)
{
	...
	V_DrawCenteredString(BASEVIDWIDTH/2, BASEVIDHEIGHT/2, 0, "Looking for servers...");
	V_DrawCenteredString(BASEVIDWIDTH/2, (BASEVIDHEIGHT/2)+12, 0, "Loading...");
	I_OsPolling();
	I_UpdateNoBlit();
	if (rendermode == render_soft)
...
static void M_ConnectIP(INT32 choice)
{
	...
	V_DrawCenteredString(BASEVIDWIDTH/2, BASEVIDHEIGHT/2, 0, "Now Loading...");
	I_OsPolling();
	I_UpdateNoBlit();
	if (rendermode == render_soft)
		I_FinishUpdate(); // page flip or blit buffer
