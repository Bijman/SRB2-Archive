...
#ifdef SRB2PLUS // net save game for new player vars
        WRITEINT16(save_p, players[i].lastinflictor);
        WRITEUINT32(save_p, players[i].lastinflictortime);
        WRITEUINT32(save_p, players[i].startflashingtics);
        WRITEANGLE(save_p, players[i].jumpangle);
#endif
...
#ifdef SRB2PLUS // net load game for new player vars
        players[i].lastinflictor = READINT16(save_p);
        players[i].lastinflictortime = READUINT32(save_p);
        players[i].startflashingtics = READUINT32(save_p);
        players[i].jumpangle = READANGLE(save_p);
#endif
