...
#ifdef RABBIT // CSTODO: Move this header file when done
#include "CS_Global.h"
#endif
...
void R_SetupFrame(player_t *player)
{
	...
	// use the player's eyes view
	{
		...
		if (csdisplayplayer != self_id && virtualplayers[csdisplayplayer].mo && virtualplayers[csdisplayplayer].in_game &&
            ! virtualplayers[csdisplayplayer].spectator)
        {
            aimingangle = virtualplayers[csdisplayplayer].aiming;
            viewangle = virtualplayers[csdisplayplayer].mo->angle;
            viewz = virtualplayers[csdisplayplayer].mo->z + (cv_viewheight.value << FRACBITS);
            if (virtualplayers[csdisplayplayer].powers[pw_gravityboots])
                viewz = virtualplayers[csdisplayplayer].mo->z + virtualplayers[csdisplayplayer].mo->height - (cv_viewheight.value << FRACBITS);
            viewmobj = virtualplayers[csdisplayplayer].mo;
        }
        else
