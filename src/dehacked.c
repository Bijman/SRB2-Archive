...
static inline int lib_getenum(lua_State *L)
{
	...
	if (fastcmp(word,"gamemap")) {
		...
		return 1;
	} else if (fastcmp(word, "itemrespawn")) {
		lua_pushinteger(L, cv_itemrespawn.value);
		return 1;
	}  else if (fastcmp(word, "normallivesnum")) {
		lua_pushinteger(L, cv_stocklives.value);
		return 1;
    }  else if (fastcmp(word, "time_limit")) {
		lua_pushinteger(L, cv_timelimit.value);
		return 1;
	}  else if (fastcmp(word, "point_limit")) {
		lua_pushinteger(L, cv_pointlimit.value);
		return 1;
	}  else if (fastcmp(word, "items_list")) {
		lua_pushinteger(L, cv_dummyteam.value);
		return 1;
	}  else if (fastcmp(word, "game_mode")) {
		lua_pushinteger(L, cv_dummyscramble.value);
		return 1;
	}  else if (fastcmp(word, "bombs")) {
		lua_pushinteger(L, cv_recycler.value);
		return 1;
	}  else if (fastcmp(word, "hamburgers")) {
		lua_pushinteger(L, cv_teleporters.value);
		return 1;
	}  else if (fastcmp(word, "pumpkins")) {
		lua_pushinteger(L, cv_superring.value);
		return 1;
	}  else if (fastcmp(word, "spikeballs")) {
		lua_pushinteger(L, cv_supersneakers.value);
		return 1;
	}  else if (fastcmp(word, "mines")) {
		lua_pushinteger(L, cv_invincibility.value);
		return 1;
	}  else if (fastcmp(word, "hearts")) {
		lua_pushinteger(L, cv_jumpshield.value);
		return 1;
	}  else if (fastcmp(word, "crates")) {
		lua_pushinteger(L, cv_watershield.value);
		return 1;
	}  else if (fastcmp(word, "superemeralds")) {
		lua_pushinteger(L, cv_ringshield.value);
		return 1;
	}  else if (fastcmp(word, "abombs")) {
		lua_pushinteger(L, cv_arecycler.value);
		return 1;
	}  else if (fastcmp(word, "ahamburgers")) {
		lua_pushinteger(L, cv_ateleporters.value);
		return 1;
	}  else if (fastcmp(word, "apumpkins")) {
		lua_pushinteger(L, cv_asuperring.value);
		return 1;
	}  else if (fastcmp(word, "aspikeballs")) {
		lua_pushinteger(L, cv_asupersneakers.value);
		return 1;
	}  else if (fastcmp(word, "amines")) {
		lua_pushinteger(L, cv_ainvincibility.value);
		return 1;
	}  else if (fastcmp(word, "nothings")) {
		lua_pushinteger(L, cv_forceshield.value);
		return 1;
	}  else if (fastcmp(word, "ahearts")) {
		lua_pushinteger(L, cv_ajumpshield.value);
		return 1;
	}  else if (fastcmp(word, "superemeralds")) {
		lua_pushinteger(L, cv_aringshield.value);
		return 1;
	}  else if (fastcmp(word, "hudoption")) {
		lua_pushinteger(L, cv_hudoption.value);
		return 1;
	}  else if (fastcmp(word, "victory")) {
		lua_pushinteger(L, cv_victory.value);
		return 1;
	}  else if (fastcmp(word, "timeup")) {
		lua_pushinteger(L, cv_timeup.value);
		return 1;
	}  else if (fastcmp(word, "timelimittics")) {
		lua_pushinteger(L, timelimitintics);
		return 1;
	}  else if (fastcmp(word, "teams")) {
		lua_pushinteger(L, cv_teams.value);
		return 1;
	}  else if (fastcmp(word, "friendlyfire")) {
		lua_pushinteger(L, cv_friendlyfire.value);
		return 1;
	}
