...
mysockaddr_t broadcastaddress[MAXNETNODES+1];
#endif
...
#else
SOCKET_TYPE mysockets[MAXNETNODES+1] = {BADSOCKET};
#endif
...
#ifdef RABBIT
UINT16 rememberthisdumbthing = 5029;
#endif
...
#ifdef RABBIT
    rememberthisdumbthing = atoi(sock_port);
#endif
