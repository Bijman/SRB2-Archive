...
#ifdef HOLIDAYS
	SPR_JACK, // Ween Jack-o-Lanturn
	SPR_TREE, // Ween bare tree
#endif
#ifdef UNIVERSE
	SPR_UITM, // SU items.
	SPR_UMON, // SU money.
	SPR_UPIP, // SU telepipes.
	SPR_KINE, // Kineso!
	SPR_BARL, // Do a barrel roll!
#endif
#ifdef SUPERVIRUS
	SPR_SVIR,
#endif
...
#endif
#ifdef RUSSIA
	SPR_SHOE, // HAHAHAHA, SONIC GOT POPPED!!
#endif
#ifdef SPRITEOFFS
	SPR_EMFG,
	SPR_EMBG,
...
typedef enum
{
...
#endif
#ifdef UNIVERSE
	// Automaticly placed teleporters for the start and end of a map...
	MT_STARTTELEPORT,
	MT_ENDTELEPORT,
	MT_TELEPIPE,
	...
	// Enemy droppings, which will generate a random item/money.
	MT_SUDROP,
	MT_SUBOSSDROP,

	// The money and items and stuffs that were dropped.
	MT_SUMONEY,
	MT_SUITEM,

	// Fired stuff for SU gun-type weapons.
	MT_SUSHOT,
