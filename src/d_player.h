...
#endif
#ifdef SRB2PLUS // new player variables
    INT16 lastinflictor; // store last player number to damage this player in case of environment kill or suicide
    tic_t lastinflictortime; // time before clearing last inflictor
    tic_t startflashingtics; // starting flashing time to calculate item pickup from
    angle_t jumpangle; // angle of jump used to calc thok force
#endif
} player_t;
