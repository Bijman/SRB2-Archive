...
#ifndef NORMALSRB2
		// SRB2CBTODO: Make sure this just respawns, not kill
		if (players[playernum].mo && !players[playernum].spectator && players[playernum].skin != previousskin)
			P_DamageMobj(players[playernum].mo, NULL, NULL, 10001);
#endif
