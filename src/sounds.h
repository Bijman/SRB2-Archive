...
typedef enum
{
	...
	mus_mwin,   // Mario Win
	mus_mok,    // Mario Ok
	mus_mlose,  // Mario Miss
	mus_swin,   // SRB2 Win
	mus_slose,  // SRB2 Miss
	mus_rmenu,  // Riders Menu
	mus_mmenu,  // Kart Menu
	mus_opmenu, // Riders Options Menu
	mus_rinvnc, // Riders invincibility
	mus_mega,   // Mario Mega Mushroom
	mus_wait2j, // Waiting to Join Netgame
#endif
