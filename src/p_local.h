...
#ifdef RIDERS
//64 is the highest speed ever hit, this is just set a bit higher so some control is kept
#define MAXMOVE (66*FRACUNIT/NEWTICRATERATIO)
#else
...
#ifdef RIDERS
#define riderslevel (maptol & TOL_RIDERS)
#define kartmode (maptol & TOL_KART)
#endif
...
#ifdef RIDERS
void P_PlayBoardSound(mobj_t *source);
