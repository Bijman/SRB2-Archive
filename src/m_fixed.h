...
static inline fixed_t TMulScale16 (fixed_t a, fixed_t b, fixed_t c, fixed_t d, fixed_t e, fixed_t f) \
{ \
	return (fixed_t)((((__int64) a * (__int64) b) + ((__int64) c * (__int64) d) \
			+ ((__int64) e* (__int64) f)) >> 16); \
}

static inline fixed_t DMulScale16 (fixed_t a, fixed_t b, fixed_t c, fixed_t d) \
{ \
