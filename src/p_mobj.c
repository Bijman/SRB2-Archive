...
#ifdef RIDERS
INT32 playerstatetics[MAXPLAYERS][S_PLAY_FLY9B+1];
#else
...
boolean P_SetPlayerMobjState(mobj_t *mobj, statenum_t state)
{
	...
	{
#ifdef RIDERS
		if (kartmode && !mobj->player->powers[pw_squished])
		{
			switch (state)
			{
			case S_PLAY_STND:
				P_SetPlayerMobjState(mobj, S_PLAY_KARTSTND1);
				return true;
				break;
			case S_PLAY_RUN1:
				P_SetPlayerMobjState(mobj, S_PLAY_KARTWALK1);
				return true;
				break;
			case S_PLAY_SPD1:
				P_SetPlayerMobjState(mobj, S_PLAY_KARTRUN1);
				return true;
				break;
			case S_PLAY_ATK1:
				P_SetPlayerMobjState(mobj, S_PLAY_KARTATK);
				return true;
				break;
			case S_PLAY_PLG1:
				P_SetPlayerMobjState(mobj, S_PLAY_KARTPLG1);
				return true;
				break;
			case S_PLAY_PAIN:
				P_SetPlayerMobjState(mobj, S_PLAY_KARTPAIN);
				return true;
				break;
			case S_PLAY_DIE1:
				P_SetPlayerMobjState(mobj, S_PLAY_KARTDIE1);
				return true;
				break;
			case S_PLAY_DIE2:
				P_SetPlayerMobjState(mobj, S_PLAY_KARTDIE2);
				return true;
				break;
			case S_PLAY_DIE3:
				P_SetPlayerMobjState(mobj, S_PLAY_KARTDIE3);
				return true;
				break;
			case S_PLAY_FALL1:
				P_SetPlayerMobjState(mobj, S_PLAY_KARTSTND1);
		...
		if (kartmode && mobj->player->powers[pw_squished] > 0)
		{
			switch (state)
			{
			case S_PLAY_STND:
				P_SetPlayerMobjState(mobj, S_PLAY_KARTSSTND);
				return true;
				break;
			case S_PLAY_RUN1:
				P_SetPlayerMobjState(mobj, S_PLAY_KARTSWALK1);
				return true;
				break;
			case S_PLAY_SPD1:
				P_SetPlayerMobjState(mobj, S_PLAY_KARTSRUN1);
				return true;
				break;
			case S_PLAY_ATK1:
				P_SetPlayerMobjState(mobj, S_PLAY_KARTSATK);
				return true;
				break;
			case S_PLAY_PLG1:
				P_SetPlayerMobjState(mobj, S_PLAY_KARTSPLG1);
				return true;
				break;
			case S_PLAY_PAIN:
				P_SetPlayerMobjState(mobj, S_PLAY_KARTSPAIN);
				return true;
				break;
			case S_PLAY_DIE1:
				P_SetPlayerMobjState(mobj, S_PLAY_KARTSDIE1);
				return true;
				break;
			case S_PLAY_DIE2:
				P_SetPlayerMobjState(mobj, S_PLAY_KARTSDIE2);
				return true;
				break;
			case S_PLAY_DIE3:
				P_SetPlayerMobjState(mobj, S_PLAY_KARTSDIE3);
				return true;
				break;
			case S_PLAY_FALL1:
				P_SetPlayerMobjState(mobj, S_PLAY_KARTSSTND);
		...
		if (!kartmode && !riderslevel)
		{
			...
			{
			case S_PLAY_STND:
				P_SetPlayerMobjState(mobj, S_PLAY_RSTND);
				return true;
				break;
			case S_PLAY_RUN1:
				P_SetPlayerMobjState(mobj, S_PLAY_RRUN1);
				return true;
				break;
			case S_PLAY_RUN2:
				P_SetPlayerMobjState(mobj, S_PLAY_RRUN2);
				return true;
				break;
			case S_PLAY_RUN3:
				P_SetPlayerMobjState(mobj, S_PLAY_RRUN3);
				return true;
				break;
			case S_PLAY_RUN4:
				P_SetPlayerMobjState(mobj, S_PLAY_RRUN4);
				return true;
				break;
			case S_PLAY_RUN5:
				P_SetPlayerMobjState(mobj, S_PLAY_RRUN5);
				return true;
				break;
			case S_PLAY_RUN6:
				P_SetPlayerMobjState(mobj, S_PLAY_RRUN6);
				return true;
				break;
			case S_PLAY_RUN7:
				P_SetPlayerMobjState(mobj, S_PLAY_RRUN7);
				return true;
				break;
			case S_PLAY_RUN8:
				P_SetPlayerMobjState(mobj, S_PLAY_RRUN8);
				return true;
				break;
			case S_PLAY_ATK1:
				P_SetPlayerMobjState(mobj, S_PLAY_RATK1);
				return true;
				break;
			case S_PLAY_ATK2:
				P_SetPlayerMobjState(mobj, S_PLAY_RATK2);
				return true;
				break;
			case S_PLAY_ATK3:
				P_SetPlayerMobjState(mobj, S_PLAY_RATK3);
				return true;
				break;
			case S_PLAY_ATK4:
				P_SetPlayerMobjState(mobj, S_PLAY_RATK4);
				return true;
				break;
			case S_PLAY_PLG1:
				P_SetPlayerMobjState(mobj, S_PLAY_RPLG1);
				return true;
				break;
			case S_PLAY_ABL1:
				P_SetPlayerMobjState(mobj, S_PLAY_RABL1);
				return true;
				break;
			case S_PLAY_ABL2:
				P_SetPlayerMobjState(mobj, S_PLAY_RABL2);
				return true;
				break;
			case S_PLAY_PAIN:
				P_SetPlayerMobjState(mobj, S_PLAY_RPAIN);
				return true;
				break;
			case S_PLAY_DIE1:
				P_SetPlayerMobjState(mobj, S_PLAY_RDIE1);
				return true;
				break;
			case S_PLAY_DIE2:
				P_SetPlayerMobjState(mobj, S_PLAY_RDIE2);
				return true;
				break;
			case S_PLAY_DIE3:
				P_SetPlayerMobjState(mobj, S_PLAY_RDIE3);
				return true;
				break;
			default:
				break;
		...
		if (!riderslevel && !kartmode && mobj->player->runframe == 0)
		{
			switch (state)
			{
			case S_PLAY_SPD1:
				P_SetPlayerMobjState(mobj, S_PLAY_RSPD1);
				return true;
				break;
			case S_PLAY_SPD2:
				P_SetPlayerMobjState(mobj, S_PLAY_RSPD2);
				return true;
				break;
			case S_PLAY_SPD3:
				P_SetPlayerMobjState(mobj, S_PLAY_RSPD3);
				return true;
				break;
			case S_PLAY_SPD4:
				P_SetPlayerMobjState(mobj, S_PLAY_RSPD4);
				return true;
				break;
			default:
				break;
		...
		if (!riderslevel && !kartmode && mobj->player->runframe == 1)
		{
			switch (state)
			{
			case S_PLAY_SPD1:
				P_SetPlayerMobjState(mobj, S_PLAY_SKATE1);
				return true;
				break;
			case S_PLAY_SPD2:
				P_SetPlayerMobjState(mobj, S_PLAY_SKATE2);
				return true;
				break;
			case S_PLAY_SPD3:
				P_SetPlayerMobjState(mobj, S_PLAY_SKATE3);
				return true;
				break;
			case S_PLAY_SPD4:
				P_SetPlayerMobjState(mobj, S_PLAY_SKATE4);
				return true;
				break;
			default:
				break;
		...
		if (!riderslevel && !kartmode && mobj->player->runframe == 2)
		{
			switch (state)
			{
			case S_PLAY_SPD1:
				P_SetPlayerMobjState(mobj, S_PLAY_CRUN1);
				return true;
				break;
			case S_PLAY_SPD2:
				P_SetPlayerMobjState(mobj, S_PLAY_CRUN2);
				return true;
				break;
			case S_PLAY_SPD3:
				P_SetPlayerMobjState(mobj, S_PLAY_CRUN3);
				return true;
				break;
			case S_PLAY_SPD4:
				P_SetPlayerMobjState(mobj, S_PLAY_CRUN4);
				return true;
				break;
			default:
				break;
		...
		if (!(mobj->state == &states[S_PLAY_PAIN] || mobj->state == &states[S_PLAY_KARTPAIN] || mobj->state == &states[S_PLAY_KARTSPAIN] || mobj->state == &states[S_PLAY_RPAIN]) && mobj->player->powers[pw_flashing] == flashingtics)
...
void P_CheckGravity(mobj_t *mo, boolean affect)
{
	...
	{
#ifdef RIDERS
		if (riderslevel && mo->player->charexgear == 1 && ((mo->player->powers[pw_tailsfly])
        || (mo->player->mo->state == &states[S_PLAY_ATK1]) || mo->player->mo->state == &states[S_PLAY_ATK2]
        || mo->player->mo->state == &states[S_PLAY_ATK3] || mo->player->mo->state == &states[S_PLAY_ATK4]))
			gravityadd = gravityadd/2; // less gravity while air riding
		if ((mo->player->charability == CA_FLY || mo->player->charability == CA_CFLY || mo->player->charability == CA_EGGFLY) && ((mo->player->powers[pw_tailsfly]) || (mo->player->mo->state == &states[S_PLAY_FLY1]) || (mo->player->mo->state == &states[S_PLAY_FLY2]) || (mo->player->mo->state == &states[S_PLAY_FLY3]) || (mo->player->mo->state == &states[S_PLAY_FLY4])))
#else
...
#ifdef RIDERS
		else if (mo->type == MT_SHELLITEM || mo->type == MT_FIREBALL || mo->type == MT_REDSHELLITEM
		|| mo->type == MT_REDSHELLITEM2 || mo->type == MT_BANANAITEM || mo->type == MT_BLACKSHELLITEM
		|| mo->type == MT_FAKEITEM || mo->type == MT_BOMBITEM || mo->type == MT_KITCHENSINK)
			P_SetMobjState(mo, S_DISS);
		/*// Hopefully fixes the stupid death-crashes.
		else if (mo->type == MT_SHELLSHIELD || mo->type == MT_REDSHELLSHIELD
		|| mo->type == MT_BANANASHIELD || mo->type == MT_FAKESHIELD
		|| mo->type == MT_BOMBSHIELD)
			P_SetMobjState(mo, S_DISS);*/
#endif
	}
	...
	do
	{
		...
		if (!P_TryMove(mo, ptryx, ptryy, true) && !tmsprung)
		{
			...
			if (mo->flags & MF_BOUNCE)
			{
				...
				if (mo->type == MT_BLACKSHELLITEM)
				{
					mo->target = NULL;
					//mo->flags &= MF_NOCLIPTHING;
					mo->health = 0;
					P_SetMobjState(mo, S_RINGEXPLODE);
				}
				...
				if (mo->type == MT_REDSHELLITEM || mo->type == MT_REDSHELLITEM2)
				{
					P_SetMobjState(mo, S_DISS);
					S_StartSound(mo, mo->info->deathsound);
				}
...
#ifdef RIDERS
	if (mo->type == MT_SHELLITEM || mo->type == MT_REDSHELLITEM || mo->type == MT_REDSHELLITEM2 || mo->type == MT_BLACKSHELLITEM)
		return;

	if (mo->player && mo->player->powers[pw_tailsfly] > 0 && mo->player->speed > mo->player->normalspeed/2)
	{
		mo->momx = FixedMul(mo->momx, mo->friction);
		mo->momy = FixedMul(mo->momy, mo->friction);
		return; // no friction when flying slow
	}
#endif
...
/*	if (mo->pmomz && mo->z > mo->floorz && !(mo->player->pflags & PF_JUMPED))
	...
	if (P_IsObjectOnGround(mo))
	{
		...
		// Get up if you fell.
#ifdef RIDERS
		if (mo->state == &states[S_PLAY_PAIN] || mo->state == &states[S_PLAY_KARTPAIN] || mo->state == &states[S_PLAY_KARTSPAIN] || mo->state == &states[S_PLAY_RPAIN])
#else
		...
		for (rover = sector->ffloors; rover; rover = rover->next)
		{
				...
				|| (!(mobj->eflags & MFE_VERTICALFLIP) && mobj->z + FIXEDSCALE(mobj->info->height/2, mobj->scale) < *rover->topheight))
			{
				...
				if (mobj->player)
				{
					...
					{
#ifdef RIDERS
						if (!(maptol & TOL_NIGHTS) && !mariomode && !kartmode)
#else
...
void P_SpawnParaloop(fixed_t x, fixed_t y, fixed_t z, fixed_t radius, INT32 number, mobjtype_t type, angle_t rotangle, boolean spawncenter, boolean ghostit)
{
	...
	for (i = 0; i < number; i++)
	{
		...
		if (kartmode)
		{
		mobj->momx = FixedMul(FixedDiv(x - mobjx, dist), 15*FRACUNIT);
		mobj->momy = FixedMul(FixedDiv(y - mobjy, dist), 15*FRACUNIT);
		mobj->momz = FixedMul(FixedDiv(z - mobjz, dist), 15*FRACUNIT);
		}
		else
		{
#endif
...
static boolean P_ShieldLook(mobj_t *thing, powertype_t power)
{
...
#ifdef RIDERS
		|| (!(riderslevel || kartmode) && thing->target->player->powers[pw_invulnerability] > 1))
#else
	...
	if ((power == pw_zwatershield) || (power == pw_zjumpshield) || (power == pw_zbombshield) || (power == pw_ringshield))
		thing->flags2 |= MF2_SHADOW;
	else if ((power == pw_watershield) || (power == pw_jumpshield) || (power == pw_bombshield) || (power == pw_zringshield))
		thing->flags2 &= ~MF2_SHADOW;
		...
		case MT_DRIFT:
			{
				...
				if (mobj->type == MT_CHEESE || mobj->type == MT_CHIP)
					DIST = FIXEDSCALE(64, mobj->target->scale);
				else if (mobj->type == MT_BIRDIE)
					DIST = FIXEDSCALE(46, mobj->target->scale);
				else
					DIST = FIXEDSCALE(7, mobj->target->scale);
				radius = DIST*FRACUNIT;

				// If there's no target, destroy yourself.
				if (!mobj->target || (mobj->target->health <= 0)) // This should NEVER happen.
				{
					if(cv_debug)
						CONS_Printf("Error: The Puffballs have no target\n");
					P_SetMobjState(mobj, S_DISS);
					return;
				}
				// If the player turned you off, destroy yourself too.
				if ((mobj->target->player && mobj->type == MT_CHEESE && mobj->target->player->cheese == 0)
					|| (mobj->target->player && mobj->type == MT_CHIP && mobj->target->player->chip == 0)
					|| (mobj->target->player && mobj->type == MT_BIRDIE && mobj->target->player->birdie == 0)
					|| (mobj->target->player && mobj->type == MT_DRIFT && mobj->target->player->powers[pw_driftcharge] == 0))
				{
					P_SetMobjState(mobj, S_DISS);
					return;
				}

				// Switch frames to their idle position
				if (mobj->target->player && mobj->target->player->speed < mobj->target->player->runspeed)
				{
					if (mobj->type == MT_CHEESE && !(mobj->state >= &states[S_CHEESE1] && mobj->state <= &states[S_CHEESE2]))
						P_SetMobjStateNF(mobj, S_CHEESE1);
					if (mobj->type == MT_CHIP && !(mobj->state >= &states[S_CHIP1] && mobj->state <= &states[S_CHIP2]))
						P_SetMobjStateNF(mobj, S_CHIP1);
					if (mobj->type == MT_BIRDIE && !(mobj->state >= &states[S_BIRDIE1] && mobj->state <= &states[S_BIRDIE2]))
						P_SetMobjStateNF(mobj, S_BIRDIE1);
				}

				// Switch frames to their running position
				if (mobj->target->player && mobj->target->player->speed > mobj->target->player->runspeed)
				{
					if (mobj->type == MT_CHEESE && !(mobj->state >= &states[S_CHEESE3] && mobj->state <= &states[S_CHEESE4]))
						P_SetMobjStateNF(mobj, S_CHEESE3);
					if (mobj->type == MT_CHIP && !(mobj->state >= &states[S_CHIP3] && mobj->state <= &states[S_CHIP4]))
						P_SetMobjStateNF(mobj, S_CHIP3);
					if (mobj->type == MT_BIRDIE && !(mobj->state >= &states[S_BIRDIE3] && mobj->state <= &states[S_BIRDIE4]))
						P_SetMobjStateNF(mobj, S_BIRDIE3);
				}

				// Switch blue flames to red flames
				if (mobj->target->player && mobj->type == MT_DRIFT
				&& mobj->target->player->powers[pw_driftcharge] > 80
				&& !(mobj->state >= &states[S_DRIFT4] && mobj->state <= &states[S_DRIFT6]))
					P_SetMobjStateNF(mobj, S_DRIFT4);

				// Get the angle of the puffballs depending on what variable you chose.
				if (mobj->type == MT_CHEESE)
					mobj->angle = ANGLE_45 + (mobj->target->angle + ANGLE_180);
				else if (mobj->type == MT_CHIP)
					mobj->angle = ANGLE_45 + (mobj->target->angle + ANGLE_90);
				else if (mobj->type == MT_BIRDIE || mobj->type == MT_DRIFT)
					mobj->angle = ANGLE_180 + mobj->target->angle;

				// If the player is on the ceiling, then flip the puffballs as well.
				if (mobj->type == MT_CHEESE || mobj->type == MT_CHIP || mobj->type == MT_BIRDIE)
				{
					if (mobj->target->player && mobj->target->eflags & MFE_VERTICALFLIP)
					{
						mobj->eflags |= MFE_VERTICALFLIP;
						HEIGHT = mobj->target->height / -1;
					}
					else
					{
						mobj->eflags &= ~MFE_VERTICALFLIP;
				...
				// Shrink the puffballs if the player shrunk too.
			...
			break;
			case MT_SHELLSHIELD:
			case MT_REDSHELLSHIELD:
			case MT_BANANASHIELD:
			case MT_FAKESHIELD:
			case MT_BOMBSHIELD:
			case MT_TSHELLSHIELD:
			case MT_TSHELLSHIELD2:
			case MT_TSHELLSHIELD3:
			case MT_TREDSHELLSHIELD:
			case MT_TREDSHELLSHIELD2:
			case MT_TREDSHELLSHIELD3:
			case MT_BANANASHIELD2:
			case MT_BANANASHIELD3:
			case MT_BOMBSHIELD2:
			case MT_BOMBSHIELD3:
			case MT_BLACKSHELLSHIELD:
			case MT_TBLACKSHELLSHIELD:
			case MT_TBLACKSHELLSHIELD2:
			case MT_TBLACKSHELLSHIELD3:
			{
				INT32 zfixds = 56;
				if (mobj->type == MT_BANANASHIELD || mobj->type == MT_BANANASHIELD2 || mobj->type == MT_BANANASHIELD3)
					zfixds = 64;
				else
					zfixds = 56;

				INT32 DIST = FIXEDSCALE(zfixds, mobj->target->scale);
				INT32 HEIGHT;
				const fixed_t radius = DIST*FRACUNIT; // mobj's distance from its Target, or Radius.

				if (!mobj->target || mobj->target->player->health <= 0) // This should NEVER happen.
				{
					P_SetMobjState(mobj, S_DISS);
					//return;
				}
				// Remove 'shield'. I honestly couldn't figure out how to combine it all :<
				if ((mobj->target->player->powers[pw_shell] == 0 || mobj->target->player->powers[pw_shell] == 2 || mobj->target->player->powers[pw_shell] == 12)
				&& !mobj->target->player->powers[pw_redshell] && !mobj->target->player->powers[pw_banana]
				&& !mobj->target->player->powers[pw_fakeitem] && !mobj->target->player->powers[pw_bomb] 
				&& !mobj->target->player->powers[pw_blackshell])
					P_SetMobjState(mobj, S_DISS);
				if ((mobj->target->player->powers[pw_redshell] == 0 || mobj->target->player->powers[pw_redshell] == 2 || mobj->target->player->powers[pw_redshell] == 12)
				&& !mobj->target->player->powers[pw_shell] && !mobj->target->player->powers[pw_banana]
				&& !mobj->target->player->powers[pw_fakeitem] && !mobj->target->player->powers[pw_bomb]
				&& !mobj->target->player->powers[pw_blackshell])
					P_SetMobjState(mobj, S_DISS);
				if ((mobj->target->player->powers[pw_banana] == 0 || mobj->target->player->powers[pw_banana] == 2 || mobj->target->player->powers[pw_banana] == 12)
				&& !mobj->target->player->powers[pw_shell] && !mobj->target->player->powers[pw_redshell]
				&& !mobj->target->player->powers[pw_fakeitem] && !mobj->target->player->powers[pw_bomb]
				&& !mobj->target->player->powers[pw_blackshell])
					P_SetMobjState(mobj, S_DISS);
				if (mobj->target->player->powers[pw_fakeitem] > 1
				&& !mobj->target->player->powers[pw_shell] && !mobj->target->player->powers[pw_redshell]
				&& !mobj->target->player->powers[pw_banana] && !mobj->target->player->powers[pw_bomb]
				&& !mobj->target->player->powers[pw_blackshell])
					P_SetMobjState(mobj, S_DISS);
				if ((mobj->target->player->powers[pw_bomb] == 0 || mobj->target->player->powers[pw_bomb] == 2 || mobj->target->player->powers[pw_bomb] == 12)
				&& !mobj->target->player->powers[pw_shell] && !mobj->target->player->powers[pw_redshell]
				&& !mobj->target->player->powers[pw_banana] && !mobj->target->player->powers[pw_fakeitem]
				&& !mobj->target->player->powers[pw_blackshell])
					P_SetMobjState(mobj, S_DISS);
				if ((mobj->target->player->powers[pw_blackshell] == 0 || mobj->target->player->powers[pw_blackshell] == 2 || mobj->target->player->powers[pw_blackshell] == 12)
				&& !mobj->target->player->powers[pw_shell] && !mobj->target->player->powers[pw_redshell]
				&& !mobj->target->player->powers[pw_banana] && !mobj->target->player->powers[pw_bomb]
				&& !mobj->target->player->powers[pw_fakeitem])
					P_SetMobjState(mobj, S_DISS);
				
				//mobj->angle += FixedAngle(12*FRACUNIT); // mobj's actual speed.
				if (mobj->type == MT_TSHELLSHIELD || mobj->type == MT_TSHELLSHIELD2 || mobj->type == MT_TSHELLSHIELD3 
				|| mobj->type == MT_TREDSHELLSHIELD || mobj->type == MT_TREDSHELLSHIELD2 || mobj->type == MT_TREDSHELLSHIELD3
				|| mobj->type == MT_TBLACKSHELLSHIELD || mobj->type == MT_TBLACKSHELLSHIELD2 || mobj->type == MT_TBLACKSHELLSHIELD3)
					mobj->angle += FixedAngle(mobj->info->speed);
				else if (mobj->type == MT_BANANASHIELD2 || mobj->type == MT_BOMBSHIELD2)
					mobj->angle = (mobj->target->angle + ANGLE_135);
				else if (mobj->type == MT_BANANASHIELD3 || mobj->type == MT_BOMBSHIELD3)
				...
				//INT32 zdopefix;
				// For these shields, threshold means the player holding
				// an item got hit, either by another player or an item.
				if (mobj->type == MT_SHELLSHIELD && mobj->threshold == 1 && mobj->target && mobj->target->player)
				{
					mobj->target->player->powers[pw_itemslot]+=10;
					mobj->target->player->powers[pw_shell] = 0; // We remove your item,
				}
				if ((mobj->type == MT_SHELLSHIELD || mobj->type == MT_TSHELLSHIELD || mobj->type == MT_TSHELLSHIELD2 
				|| mobj->type == MT_TSHELLSHIELD3) && mobj->target && mobj->target->player && mobj->target->player->powers[pw_shell] == 0)
				{
					mobj->target->player->powers[pw_triples] = 0;
					mobj->target->player->powers[pw_triples2] = 0;
					P_SetMobjState(mobj, S_DISS); // and remove the shield.
				}

				if (mobj->type == MT_REDSHELLSHIELD && mobj->threshold == 1 && mobj->target && mobj->target->player)
				{
					mobj->target->player->powers[pw_itemslot]+=10;
					mobj->target->player->powers[pw_redshell] = 0;
				}
				if ((mobj->type == MT_REDSHELLSHIELD || mobj->type == MT_TREDSHELLSHIELD || mobj->type == MT_TREDSHELLSHIELD2 
				|| mobj->type == MT_TREDSHELLSHIELD3) && mobj->target && mobj->target->player && mobj->target->player->powers[pw_redshell] == 0)
				{
					mobj->target->player->powers[pw_triples] = 0;
					mobj->target->player->powers[pw_triples2] = 0;
					P_SetMobjState(mobj, S_DISS); 
				}
				if (mobj->type == MT_BLACKSHELLSHIELD && mobj->threshold == 1 && mobj->target && mobj->target->player)
				{
					mobj->target->player->powers[pw_itemslot]+=10;
					mobj->target->player->powers[pw_blackshell] = 0;
				}
				if ((mobj->type == MT_BLACKSHELLSHIELD || mobj->type == MT_TBLACKSHELLSHIELD || mobj->type == MT_TBLACKSHELLSHIELD2 
				|| mobj->type == MT_TBLACKSHELLSHIELD3) && mobj->target && mobj->target->player && mobj->target->player->powers[pw_blackshell] == 0)
				{
					mobj->target->player->powers[pw_triples] = 0;
					mobj->target->player->powers[pw_triples2] = 0;
					P_SetMobjState(mobj, S_DISS); 
				...
				|| mobj->type == MT_TREDSHELLSHIELD || mobj->type == MT_TREDSHELLSHIELD2 || mobj->type == MT_TREDSHELLSHIELD3
				|| mobj->type == MT_TBLACKSHELLSHIELD || mobj->type == MT_TBLACKSHELLSHIELD2 || mobj->type == MT_TBLACKSHELLSHIELD3
				|| mobj->type == MT_BOMBSHIELD2 || mobj->type == MT_BOMBSHIELD3
				|| mobj->type == MT_BANANASHIELD2 || mobj->type == MT_BANANASHIELD3) && mobj->target->player->powers[pw_triples] == 0)
				{
					mobj->target->player->powers[pw_triples] = 0;
					mobj->target->player->powers[pw_triples2] = 0;
					P_SetMobjState(mobj, S_DISS);
				...
				if ((mobj->type == MT_BANANASHIELD || mobj->type == MT_BANANASHIELD2 || mobj->type == MT_BANANASHIELD3)
				&& mobj->target && mobj->target->player && mobj->target->player->powers[pw_banana] == 0)
				{
					mobj->target->player->powers[pw_triples] = 0;
					mobj->target->player->powers[pw_triples2] = 0;
					P_SetMobjState(mobj, S_DISS);
				...
				if (mobj->type == MT_FAKESHIELD && mobj->threshold == 1 && mobj->target && mobj->target->player)
				{
					mobj->target->player->powers[pw_itemslot]+=10;
					mobj->target->player->powers[pw_fakeitem] = 0;
				}
				if (mobj->type == MT_FAKESHIELD && mobj->target && mobj->target->player && mobj->target->player->powers[pw_fakeitem] == 0)
					P_SetMobjState(mobj, S_DISS);

				if (mobj->type == MT_BOMBSHIELD && mobj->threshold == 1 && mobj->target && mobj->target->player)
				{
					mobj->target->player->powers[pw_itemslot]+=10;
					mobj->target->player->powers[pw_bomb] = 0;
				}
				if (mobj->type == MT_BOMBSHIELD && mobj->target && mobj->target->player && mobj->target->player->powers[pw_bomb] == 0
				&& mobj->threshold == 0)
					P_SetMobjState(mobj, S_DISS);
				if (mobj->type == MT_BOMBSHIELD && mobj->target && mobj->target->player && mobj->target->player->powers[pw_bomb] == 0
				&& mobj->threshold == 1)
				{
					...
					fixed_t newy;
					mobj_t *mo;
					newangle = mobj->target->angle;
					newx = mobj->target->x + P_ReturnThrustX(mobj->target, newangle + ANGLE_180, 64*FRACUNIT);
					newy = mobj->target->y + P_ReturnThrustY(mobj->target, newangle + ANGLE_180, 64*FRACUNIT);
					mo = P_SpawnMobj(newx, newy, mobj->target->z, MT_BOMBITEM);
					P_SetMobjState(mo, mo->info->deathstate);
					P_SetMobjState(mobj, S_DISS);
				}

				if ((mobj->type == MT_TSHELLSHIELD || mobj->type == MT_TSHELLSHIELD2 || mobj->type == MT_TSHELLSHIELD3)
				&& mobj->threshold == 1 && mobj->target && mobj->target->player)
				{
					if (mobj->target->player->powers[pw_triples] > 0)
						mobj->target->player->powers[pw_triples]--;
					//
					if (mobj->type == MT_TSHELLSHIELD && !(mobj->target->player->powers[pw_triples2] & 1))
						mobj->target->player->powers[pw_triples2] += 1;
					else if (mobj->type == MT_TSHELLSHIELD2 && !(mobj->target->player->powers[pw_triples2] & 2))
						mobj->target->player->powers[pw_triples2] += 2;
					else if (mobj->type == MT_TSHELLSHIELD3 && !(mobj->target->player->powers[pw_triples2] & 4))
						mobj->target->player->powers[pw_triples2] += 4;
					//
					if (mobj->target->player->powers[pw_triples] == 0)
					{
						mobj->target->player->powers[pw_triples2] = 0;
						mobj->target->player->powers[pw_shell] = 0;
						mobj->target->player->powers[pw_itemslot]+=10;
					}
					P_SetMobjState(mobj, S_DISS);
				}
				if ((mobj->type == MT_TREDSHELLSHIELD || mobj->type == MT_TREDSHELLSHIELD2 || mobj->type == MT_TREDSHELLSHIELD3)
				&& mobj->threshold == 1 && mobj->target && mobj->target->player)
				{
					if (mobj->target->player->powers[pw_triples] > 0)
						mobj->target->player->powers[pw_triples]--;
					//
					if (mobj->type == MT_TREDSHELLSHIELD && !(mobj->target->player->powers[pw_triples2] & 1))
						mobj->target->player->powers[pw_triples2] += 1;
					else if (mobj->type == MT_TREDSHELLSHIELD2 && !(mobj->target->player->powers[pw_triples2] & 2))
						mobj->target->player->powers[pw_triples2] += 2;
					else if (mobj->type == MT_TREDSHELLSHIELD3 && !(mobj->target->player->powers[pw_triples2] & 4))
						mobj->target->player->powers[pw_triples2] += 4;
					//
					if (mobj->target->player->powers[pw_triples] == 0)
					{
				...
				&& mobj->threshold == 1 && mobj->target && mobj->target->player)
				{
					if (mobj->target->player->powers[pw_triples] > 0)
						mobj->target->player->powers[pw_triples]--;
					//
					if (mobj->type == MT_BANANASHIELD && !(mobj->target->player->powers[pw_triples2] & 1))
						mobj->target->player->powers[pw_triples2] += 1;
					else if (mobj->type == MT_BANANASHIELD2 && !(mobj->target->player->powers[pw_triples2] & 2))
						mobj->target->player->powers[pw_triples2] += 2;
					else if (mobj->type == MT_BANANASHIELD3 && !(mobj->target->player->powers[pw_triples2] & 4))
						mobj->target->player->powers[pw_triples2] += 4;
					//
					if (mobj->target->player->powers[pw_triples] == 0)
					{
						mobj->target->player->powers[pw_triples2] = 0;
						mobj->target->player->powers[pw_banana] = 0;
						mobj->target->player->powers[pw_itemslot]+=10;
					}
					P_SetMobjState(mobj, S_DISS);
				}
				if ((mobj->type == MT_BOMBSHIELD || mobj->type == MT_BOMBSHIELD2 || mobj->type == MT_BOMBSHIELD3) 
				&& mobj->threshold == 1 && mobj->target && mobj->target->player)
				{
					if (mobj->target->player->powers[pw_triples] > 0)
						mobj->target->player->powers[pw_triples]--;
					//
					if (mobj->type == MT_BOMBSHIELD && !(mobj->target->player->powers[pw_triples2] & 1))
						mobj->target->player->powers[pw_triples2] += 1;
					else if (mobj->type == MT_BOMBSHIELD2 && !(mobj->target->player->powers[pw_triples2] & 2))
						mobj->target->player->powers[pw_triples2] += 2;
					else if (mobj->type == MT_BOMBSHIELD3 && !(mobj->target->player->powers[pw_triples2] & 4))
						mobj->target->player->powers[pw_triples2] += 4;
					//
					if (mobj->target->player->powers[pw_triples] == 0)
					{
				...
				if ((mobj->type == MT_TBLACKSHELLSHIELD || mobj->type == MT_TBLACKSHELLSHIELD2 || mobj->type == MT_TBLACKSHELLSHIELD3)
				&& mobj->threshold == 1 && mobj->target && mobj->target->player)
				{
					if (mobj->target->player->powers[pw_triples] > 0)
						mobj->target->player->powers[pw_triples]--;
					//
					if (mobj->type == MT_TBLACKSHELLSHIELD && !(mobj->target->player->powers[pw_triples2] & 1))
						mobj->target->player->powers[pw_triples2] += 1;
					else if (mobj->type == MT_TBLACKSHELLSHIELD2 && !(mobj->target->player->powers[pw_triples2] & 2))
						mobj->target->player->powers[pw_triples2] += 2;
					else if (mobj->type == MT_TBLACKSHELLSHIELD3 && !(mobj->target->player->powers[pw_triples2] & 4))
						mobj->target->player->powers[pw_triples2] += 4;
					//
					if (mobj->target->player->powers[pw_triples] == 0)
					{
				  ...
				  ///////////////////////////////////////////////////////////
				 // Now the fun begins. The horrible, agitating fun. Ugh. //
				///////////////////////////////////////////////////////////

				//	pw_triples is the main controller, while pw_triples2 looks after whether or not the
				//		item was player-touch destroyed. The former won't update pw_triples2, so below
				//			here is where we check for that and see which of the shells/peels WAS broken,
				//				so we can tell the game which thing can be used next.

				if (mobj->target->player->powers[pw_triples] == 2)
				{
					if ((mobj->target->player->powers[pw_triples2] == 0) && mobj->type == MT_BANANASHIELD3)
						P_SetMobjState(mobj, S_DISS);
					//
					else if ((mobj->target->player->powers[pw_triples2] == 0) && mobj->type == MT_TSHELLSHIELD3)
						P_SetMobjState(mobj, S_DISS);
					//
					else if ((mobj->target->player->powers[pw_triples2] == 0) && mobj->type == MT_TREDSHELLSHIELD3)
						P_SetMobjState(mobj, S_DISS);
					//
					else if ((mobj->target->player->powers[pw_triples2] == 0) && mobj->type == MT_BOMBSHIELD3)
						P_SetMobjState(mobj, S_DISS);
					//
					else if ((mobj->target->player->powers[pw_triples2] == 0) && mobj->type == MT_TBLACKSHELLSHIELD3)
						P_SetMobjState(mobj, S_DISS);
				}
				else if (mobj->target->player->powers[pw_triples] == 1)
				{
					if ((mobj->target->player->powers[pw_triples2] == 0
					  || mobj->target->player->powers[pw_triples2] == 16) && mobj->type == MT_BANANASHIELD2)
						P_SetMobjState(mobj, S_DISS);
					else if ((mobj->target->player->powers[pw_triples2] == 1
						   || mobj->target->player->powers[pw_triples2] == 2
						   || mobj->target->player->powers[pw_triples2] == 4
						   || mobj->target->player->powers[pw_triples2] == 8) && mobj->type == MT_BANANASHIELD3)
						P_SetMobjState(mobj, S_DISS);
					//
					else if ((mobj->target->player->powers[pw_triples2] == 0
					  || mobj->target->player->powers[pw_triples2] == 16) && mobj->type == MT_TSHELLSHIELD2)
						P_SetMobjState(mobj, S_DISS);
					else if ((mobj->target->player->powers[pw_triples2] == 1
						   || mobj->target->player->powers[pw_triples2] == 2
						   || mobj->target->player->powers[pw_triples2] == 4
						   || mobj->target->player->powers[pw_triples2] == 8) && mobj->type == MT_TSHELLSHIELD3)
						P_SetMobjState(mobj, S_DISS);
					//
					else if ((mobj->target->player->powers[pw_triples2] == 0
					  || mobj->target->player->powers[pw_triples2] == 16) && mobj->type == MT_TREDSHELLSHIELD2)
						P_SetMobjState(mobj, S_DISS);
					else if ((mobj->target->player->powers[pw_triples2] == 1
						   || mobj->target->player->powers[pw_triples2] == 2
						   || mobj->target->player->powers[pw_triples2] == 4
						   || mobj->target->player->powers[pw_triples2] == 8) && mobj->type == MT_TREDSHELLSHIELD3)
						P_SetMobjState(mobj, S_DISS);
					//
					else if ((mobj->target->player->powers[pw_triples2] == 0
					  || mobj->target->player->powers[pw_triples2] == 16) && mobj->type == MT_BOMBSHIELD2)
						P_SetMobjState(mobj, S_DISS);
					else if ((mobj->target->player->powers[pw_triples2] == 1
						   || mobj->target->player->powers[pw_triples2] == 2
						   || mobj->target->player->powers[pw_triples2] == 4
						   || mobj->target->player->powers[pw_triples2] == 8) && mobj->type == MT_BOMBSHIELD3)
						P_SetMobjState(mobj, S_DISS);
					//
					else if ((mobj->target->player->powers[pw_triples2] == 0
					  || mobj->target->player->powers[pw_triples2] == 16) && mobj->type == MT_TBLACKSHELLSHIELD2)
						P_SetMobjState(mobj, S_DISS);
					else if ((mobj->target->player->powers[pw_triples2] == 1
						   || mobj->target->player->powers[pw_triples2] == 2
						   || mobj->target->player->powers[pw_triples2] == 4
						   || mobj->target->player->powers[pw_triples2] == 8) && mobj->type == MT_TBLACKSHELLSHIELD3)
						P_SetMobjState(mobj, S_DISS);
				}
			}
			break;
			case MT_SKYANIMATION:
				if (mapheaderinfo[gamemap-1].skymount > 1)
				{
					if ((!mobj->health) || (mobj->health >
					(mapheaderinfo[gamemap-1].skynum + mapheaderinfo[gamemap-1].skymount - 2)))
						mobj->health = mapheaderinfo[gamemap-1].skynum;

					if (leveltime % ((mobj->angle/182)>>FRACBITS) == 0)
						mobj->health++;

					globallevelskynum = mobj->health;
					levelskynum = mobj->health;
...
/*
		...
		case MT_SHELLITEM:
			...
			if (leveltime % 6 == 0)
				S_StartSound(mobj, mobj->info->activesound);
			break;
		case MT_REDSHELLITEM:
			if (leveltime % 7 == 0)
				S_StartSound(mobj, mobj->info->activesound);
		case MT_REDSHELLITEM2:
			mobj->angle = R_PointToAngle2(mobj->x, mobj->y, mobj->x+mobj->momx, mobj->y+mobj->momy);
			P_InstaThrust(mobj, mobj->angle, mobj->info->speed);
			if (leveltime % 7 == 0)
				S_StartSound(mobj, mobj->info->activesound);
			break;
		case MT_BLACKSHELLITEM:
			mobj->angle = R_PointToAngle2(mobj->x, mobj->y, mobj->x+mobj->momx, mobj->y+mobj->momy);
			if (mobj->health)
				P_InstaThrust(mobj, mobj->angle, mobj->info->speed);
			else
		...
		case MT_FAKEITEM:
			...
			break;
		case MT_KITCHENSINK:
			if (mobj->z <= mobj->floorz && mobj->health > 0)
			{
...
#ifdef RIDERS
		else if (mobj->health > 0 && !riderslevel)
#else
		...
		if (!mobj->fuse)
		{
			...
			switch (mobj->type)
			{
...
#ifdef RIDERS
				case MT_AIRTANKBOX:
				case MT_RSUPERRINGBOX10:
				case MT_RSUPERRINGBOX20:
				case MT_RSUPERRINGBOX30:
				case MT_RINV:
				case MT_YSHIELDCAPICO:
					...
					if ((mobj->flags & MF_AMBUSH) || (mobj->flags2 & MF2_STRONGBOX))
					{
						...
						if (cv_superring.value)
						{
							...
							for (; i < oldi + increment; i++)
							{
								spawnchance[i] = MT_RSUPERRINGBOX10;
								numchoices++;
							}
						}
						if (cv_invincibility.value)
						...
						if (cv_ringshield.value)
						{
							...
							for (; i < oldi + increment; i++)
							{
								spawnchance[i] = MT_YELLOWCAPSULE;
								numchoices++;
							}
						}
				...
				case MT_QUESTIONBOX2:
					...
					//newmobj = P_SpawnMobj(x, y, z, MT_QUESTIONBOX2);

					// Transfer flags2 (strongbox, objectflip)
					//newmobj->flags2 = mobj->flags2;

					break;
				case MT_QUESTIONBOX3:
					newmobj = P_SpawnMobj(mobj->x, mobj->y, mobj->z, MT_QUESTIONBOX3);
...
//			if (!modifiedgame) // Speedup, if the game is not modified.
		...
		default:
#ifdef RIDERS
			//if ((riderslevel || kartmode) && mobj->flags & MF_MONITOR)
			//{
			//	mobj->flags &= ~MF_SOLID;
			//}
#endif
...
#ifdef RIDERS
consvar_t cv_itemrespawntime = {"respawnitemtime", "03", CV_NETVAR|CV_CHEAT, respawnitemtime_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_itemrespawn = {"respawnitem", "On", CV_NETVAR|CV_CALL, CV_OnOff, Respawn_OnChange, 0, NULL, NULL, 0, 0, NULL};
#else
...
void P_RespawnSpecials(void)
{
	...
	if (mthing)
	{
		...
		if (mthing->options & MTF_OBJECTFLIP)
		{
			...
			i == MT_EXPLODEPICKUP || i == MT_SCATTERPICKUP || i == MT_GRENADEPICKUP || i == MT_QUESTIONBOX2))
...
//#endif
	...
	//else if (netgame && gametype == GT_RACE && !countdown)
	//	p->spectator = false;

	if (p->lakitu == 1)
		p->newfloorz = mthing->z + 128;
#endif
...
#ifdef RIDERS
	{
		if (kartmode && p->lakitu)
			z = R_PointInSubsector(x, y)->sector->floorheight + (((mthing->options >> (ZSHIFT+1)) + 128) << FRACBITS);
		else
...
#ifdef RIDERS
	if (kartmode)
		z = ((p->starpostz+128) << FRACBITS); // If only P_SpawnPlayer was this easy...
#endif
...
#endif
#ifdef RIDERS
	p->powers[pw_waypoint] = p->starpostwp;
#endif
	...
	else if (i != MT_AXIS && i != MT_AXISTRANSFER && i != MT_AXISTRANSFERLINE)
	{
		...
		else if (mobjinfo[i].flags & MF_SPAWNCEILING || mthing->options & MTF_OBJECTFLIP)
		{
			...
			z = ss->sector->floorheight + ((mthing->options >> ZSHIFT) << FRACBITS);
				...
				|| i == MT_SPEEDMONITOR || i == MT_FLYMONITOR || i == MT_POWERMONITOR)
#else
		else if (i == MT_CRAWLACOMMANDER || i == MT_DETON || i == MT_JETTBOMBER || i == MT_JETTGUNNER || i == MT_EGGMOBILE || i == MT_EGGMOBILE2)
#endif
...
#ifdef RIDERS
	else if (mobj->type == MT_FIREPOINT)
	{
		fixed_t mlength, mlength2, mlength3, mlength4,
		mspeed, mxspeed, mzspeed, mstartangle, mmaxspeed;
		mobjtype_t chainlink = MT_FIRECHAIN;
		boolean firsttime;
		mobj_t *spawnee;
		size_t line;
		const size_t mthingi = (size_t)(mthing - mapthings);
...
*/
		...
		while (mlength > 0)
		{
			...
			if (lines[line].flags & ML_EFFECT1)
				mlength2 = mlength3 = mlength4 = 0;
			else
				mlength2 = mlength3 = mlength4 = mlength+2;
			while (mlength2 > 0)
			{
				spawnee = P_SpawnMobj(mobj->x, mobj->y, mobj->z, chainlink);
				...
				spawnee->threshold = FixedAngle((mstartangle+90)*FRACUNIT)>>ANGLETOFINESHIFT;
				spawnee->reactiontime = mlength2;
			...
			while (mlength3 > 0)
			{
				...
				spawnee->threshold = FixedAngle((mstartangle+180)*FRACUNIT)>>ANGLETOFINESHIFT;
				spawnee->reactiontime = mlength3;
			...
			while (mlength4 > 0)
			{
				...
				spawnee->threshold = FixedAngle((mstartangle+270)*FRACUNIT)>>ANGLETOFINESHIFT;
				spawnee->reactiontime = mlength4;
	...
	else if (mobj->type == MT_NIGHTSBUMPER)
	{
		...
		{
			mobj->flags2 |= MF2_DONTDRAW;
			mobj->height = 128*FRACUNIT;
			mobj->radius = 64*FRACUNIT;
		}
		else
		{
			mobj->height = 64*FRACUNIT;
			mobj->radius = 32*FRACUNIT;
		}
#endif
	}
	...
	else if (i == MT_BOSS3WAYPOINT) // New for updated checks 12.04.17
	{
		mobj->health = mthing->angle;
	}
...
void P_SpawnHoopsAndRings(mapthing_t *mthing)
{
	...
	else
	{
		...
		if (mthing->type == mobjinfo[MT_RING].doomednum || mthing->type == mobjinfo[MT_COIN].doomednum || mthing->type == MT_QUESTIONBOX2 ||
			...
			switch (mthing->type)
			{
				...
				case 309: //MT_BLUETEAMRING
					if (gametype == GT_CTF) //No team-specific rings outside of CTF!
						...
						mobj = P_SpawnMobj(mthing->x << FRACBITS, mthing->y << FRACBITS,mthing->z << FRACBITS, MT_RING);
					break;
				case 1478: //MT_QUESTIONBOX2
					mobj = P_SpawnMobj(mthing->x << FRACBITS, mthing->y << FRACBITS,mthing->z << FRACBITS, MT_QUESTIONBOX2);
					break;
			}
...
#ifdef RIDERS
	if (type == MT_TURRETLASER && !riderslevel) // More accurate!
#else
...
mobj_t *P_SPMAngle(mobj_t *source, mobjtype_t type, angle_t angle, boolean noaiming, boolean noautoaiming, INT32 flags2, boolean reflected)
{
	...
	{
#ifdef JTEBOTS
		if (source->player->bot || !noautoaiming)
#else
		if (!noautoaiming)
#endif
		{
	...
	if (source->player->heldDir != 0)
		dir = source->player->heldDir;
	else
		dir = 1;

	if (source->player->powers[pw_fireflower] > 1)
	{
		x = source->x + P_ReturnThrustX(source, angle, 16*FRACUNIT);
		y = source->y + P_ReturnThrustY(source, angle, 16*FRACUNIT);
	}
	else if (source->player->powers[pw_shell] == 11 || source->player->powers[pw_redshell] == 11
		 || source->player->powers[pw_blackshell] == 11 || dir == -1)
	{
		x = source->x + P_ReturnThrustX(source, angle, 96*FRACUNIT);
		y = source->y + P_ReturnThrustY(source, angle, 96*FRACUNIT);
	}
	else
	{
		x = source->x + P_ReturnThrustX(source, angle, 48*FRACUNIT);
		y = source->y + P_ReturnThrustY(source, angle, 48*FRACUNIT);
	}
