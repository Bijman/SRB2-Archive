...
static void HWR_AddSprites (sector_t* sec)
{
	...
	// PSO's drawdistance is much farther.
	#ifdef SPMOVES
...
#define WRAPANGLE (ANGLE_MAX/4)
    ...
    /* TODO: Find SOME means to make Sky2 render but only when Sky1 isn't there!
    ...
    v[0].tow = v[1].tow = (f+127)/(textures[sky2texture]->height/2);    //suppose 256x128 sky...
