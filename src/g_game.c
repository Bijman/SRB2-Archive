...
char    player_names[MAXPLAYERS][MAXPLAYERNAME] =
{
    ...
    /*"Player 33\0a123456789\0",
    "Player 34\0a123456789\0",
    "Player 35\0a123456789\0",
    "Player 36\0a123456789\0",
    "Player 37\0a123456789\0",
    "Player 38\0a123456789\0",
    "Player 39\0a123456789\0",
    "Player 40\0a123456789\0",
    "Player 41\0a123456789\0",
    "Player 42\0a123456789\0",
    "Player 43\0a123456789\0",
    "Player 44\0a123456789\0",
    "Player 45\0a123456789\0",
    "Player 46\0a123456789\0",
    "Player 47\0a123456789\0",
    "Player 48\0a123456789\0",
    "Player 49\0a123456789\0",
    "Player 50\0a123456789\0",
    "Player 51\0a123456789\0",
    "Player 52\0a123456789\0",
    "Player 53\0a123456789\0",
    "Player 54\0a123456789\0",
    "Player 55\0a123456789\0",
    "Player 56\0a123456789\0",
    "Player 57\0a123456789\0",
    "Player 58\0a123456789\0",
    "Player 59\0a123456789\0",
    "Player 60\0a123456789\0",
    "Player 61\0a123456789\0",
    "Player 62\0a123456789\0",
    "Player 63\0a123456789\0",
    "Player 64\0a123456789\0"*/
};
...
char *team_names[MAXPLAYERS] =
{
    ...
    /*"Team 33\0a90123456789b\0",
    "Team 34\0a90123456789b\0",
    "Team 35\0a90123456789b\0",
    "Team 36\0a90123456789b\0",
    "Team 37\0a90123456789b\0",
    "Team 38\0a90123456789b\0",
    "Team 39\0a90123456789b\0",
    "Team 40\0a90123456789b\0",
    "Team 41\0a90123456789b\0",
    "Team 42\0a90123456789b\0",
    "Team 43\0a90123456789b\0",
    "Team 44\0a90123456789b\0",
    "Team 45\0a90123456789b\0",
    "Team 46\0a90123456789b\0",
    "Team 47\0a90123456789b\0",
    "Team 48\0a90123456789b\0",
    "Team 49\0a90123456789b\0",
    "Team 50\0a90123456789b\0",
    "Team 51\0a90123456789b\0",
    "Team 52\0a90123456789b\0",
    "Team 53\0a90123456789b\0",
    "Team 54\0a90123456789b\0",
    "Team 55\0a90123456789b\0",
    "Team 56\0a90123456789b\0",
    "Team 57\0a90123456789b\0",
    "Team 58\0a90123456789b\0",
    "Team 59\0a90123456789b\0",
    "Team 60\0a90123456789b\0",
    "Team 61\0a90123456789b\0",
    "Team 62\0a90123456789b\0",
    "Team 63\0a90123456789b\0",
    "Team 64\0a90123456789b\0"*/
};
...
boolean G_Responder (event_t* ev)
{
    ...
    {
		if(!cv_debug && (cv_gametype.value == GT_MATCH || (cv_gametype.value == GT_TAG && !players[consoleplayer].tagit)
...
players[player].bot = bot;  //added by AC for acbot
	...
	if(netgame || multiplayer)
	{
		...
		#ifdef SPMOVES
		else if (p == &players[consoleplayer] && p->tunes)
			S_ChangeMusic(p->tunes, true);
		#endif
	}
}
...
void G_DoCompleted (void)
{
	...
	if(cv_gametype.value == GT_COOP)
	{
		if(token)
		{
			...
			else if(!(emeralds & EMERALD8))
				wminfo.next = sstage_start+6; // Special Stage 8
			else
			{
				gottoken = false;
				goto skipit;
...
skipit:
	if((emeralds & EMERALD1 && emeralds & EMERALD2 && emeralds & EMERALD3 && emeralds & EMERALD4 && 
		emeralds & EMERALD5 && emeralds & EMERALD6 && emeralds & EMERALD7 && emeralds & EMERALD8)
		&& gamemap == 9)
		wminfo.next = 15; // SRB2 Universe
...
void G_DoWorldDone (void)
{
    ...
    if(server && !demoplayback) 
    {
        if(cv_gametype.value == GT_COOP)
            ...
            COM_BufAddText (va("map \"%s\" -noresetplayers stfu\n",G_BuildMapName(wminfo.next+1)));
        else
            // resetplayer in deathmatch for more equality
            COM_BufAddText (va("map \"%s\" stfu\n",G_BuildMapName(wminfo.next+1)));
    }
...
void G_LoadGameData()
{
	...
	for(i=0; i<NUMMAPS; i++) // Temporary hack because 100-1035 aren't needed yet Graue 12-03-2003
		timedata[i].time = READULONG(save_p);
	#ifdef SPMOVES
	multieggs = READLONG(save_p);
	#endif

	// Aha! Someone's been screwing with the save file!
	if(veryhardcleared > 1)
		I_Error("Corrupt game data file.\nDelete gamedata.dat\nand try again. Mwahahaha.");
...
void G_DoLoadGame (int slot) // Working on lots of garbage here Tails 06-10-2001
{
    ...
    if(!P_LoadGame())
    {
        M_StartMessage ("the savegame file is corrupt\n\nPress ESC\n", NULL, MM_NOTHING);
        Command_ExitGame_f();
        Z_Free (savebuffer);
        return;
    }
...
void G_DeferedInitNew (skill_t skill, char* mapname, int pickedchar, boolean StartSplitScreenGame)
{
    ...
    COM_BufAddText (va("map \"%s\" -skill %d -monsters 1 stfu\n",mapname,skill+1));
}
