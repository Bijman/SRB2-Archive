...
#define VERSIONSTRING  " v1.08 SPMoves Edition" // Tails 02-18-2002
#else
...
//#define ACBOT                   // tonyd: Activate ACBots
#define FIXROVERBUGS // Fix objects-fall-through-3dfloor bug and monster sight. Tails 03-18-2002
#define SPMOVES // w00t w00t, SPMoves in da hawse!
#define CIRCUITMODE // Circuit mode! ^.^
...
#define MAXPLAYERS              32//64      // TODO: ... more!!!
...
#define PSO_DRAW_DIST 3200*FRACUNIT // They sholuldn't be able to see farther anyhow. :\
...
#define MAXLINELEN  200 // For Dehacked.c
