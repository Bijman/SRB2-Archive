...
#ifdef SRB2JTE
#define VERSION 169 // Game version
#define VERSIONSTRING " v1.69"
#elif ZELDA
#define VERSION 203 // Game version
#define VERSIONSTRING " 666"
#else
...
#if !defined(_arch_dreamcast) && !defined(_WIN32_WCE)
