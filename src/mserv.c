...
#if !defined (__APPLE_CC__)  && !defined(HAVE_LWIP) && (defined (_WIN32) || defined (_WIN32_WCE) || defined (_WIN64) || defined (__OS2__) || defined (SOLARIS) || defined(_arch_dreamcast)) && !defined (NONET)
