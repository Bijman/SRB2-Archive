...
#if defined( __GNUC__ ) && defined( SURROUND )
//#undef SURROUND //Alam_GBC: Hmmmm, get ASM code working?
static void CopyAndInvertMemory(void *dest, void *src, int bytes) __attribute__((noinline));
#endif
