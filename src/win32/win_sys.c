...
void I_AddExitFunc(void (*func)())
{
	...
	{
#ifdef BUGFIXES // RAWR. >:E
		if(quit_funcs[c] == func)
		{
			CONS_Printf("Warning: Some DUMBASS (aka Alam or SSNTails) decided it'd be alright "
						"to call I_AddExitFunc twice with the same damn function. Ignoring...\n");
			return;
		}
#endif
		if (!quit_funcs[c])
