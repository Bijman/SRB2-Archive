...
#ifdef SPMOVES
#include "spmoves.h" // SPMoves emblems!
#endif
...
typedef struct
{
	...
	short skynum;
	#ifdef SPMOVES
	short sky2num;// Not supported in old format
	short sky3num;// Not supported in old format
	short sky4num;// Not supported in old format
	short sky5num;// Not supported in old format
	short sky6num;// Not supported in old format
	short sky7num;// Not supported in old format
	short sky8num;// Not supported in old format
	short sky9num;// Not supported in old format
	byte questtype;
	#endif
	...
	boolean nozone;// Not supported in old format
} mapheader_t;
