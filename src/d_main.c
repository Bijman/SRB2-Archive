...
#ifdef RABBIT
extern int totalsent, totalrecvd;
#endif
...
#ifdef RABBIT
			// LXShadow hacked this (netstat stuff)
            sendbps = totalsent;
            getbps = totalrecvd;
#endif
            // LXShadow: Replaced all "snprintf"s with "sprintf"; for some reason snprintf is causing crashes.
