...
static void IdentifyVersion(void)
{
	...
	// Add the main
	D_AddFile(va(pandf,srb2waddir,"main.ssb"));
	
	// Add the MORE zones
	D_AddFile(va(pandf,srb2waddir,"zones.ssb"));
#endif
...
#else
		const char *musicfile = "audio.ssb";
#endif
...
void D_SRB2Main(void)
{
	...
	strcpy(title, "Sonic Smash Brawl");
	strcpy(srb2, "Sonic Smash Brawl");
	...
	snprintf(pmData->title, sizeof (pmData->title),
		"Sonic Smash Brawl" VERSIONSTRING ": %s",
		title);
...
#ifndef DEVELOP // md5s last updated 05/01/18
	...
	//W_VerifyFileMD5(5, ASSET_HASH_MAIN_SSB); // main.ssb
	//W_VerifyFileMD5(6, ASSET_HASH_ZONES_SSB); // zones.ssb
#endif
	...
	mainwads = 4; // there are 6 wads not to unload
#ifdef USE_PATCH_DTA
