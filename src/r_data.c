...
int R_GetFlatNumForName(char *name)
{
  ...
  if(lump == -1)
  {
	...
	&& strcmp(name, SKY2FLATNAME)
	&& strcmp(name, SKY3FLATNAME)
	&& strcmp(name, SKY4FLATNAME)
	&& strcmp(name, SKY5FLATNAME)
	&& strcmp(name, SKY6FLATNAME)
	&& strcmp(name, SKY7FLATNAME)
	&& strcmp(name, SKY8FLATNAME)
	&& strcmp(name, SKY9FLATNAME)) // Ignore the F_SKY1 missing error Tails 05-06-2003
