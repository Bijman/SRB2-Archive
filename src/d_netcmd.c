...
static CV_PossibleValue_t theovertime_cons_t[] = {{0, "ohgodherewegoagain"}, {1, "fuckingsuddendeathintensifies"}, {0, NULL}};
static CV_PossibleValue_t victory_cons_t[] = {{0, "whataboringfight"}, {1, "fuckingfinally"}, {0, NULL}};
static CV_PossibleValue_t timeup_cons_t[] = {{0, "whatisthisbullshit"}, {1, "FUCKINGRINGRING"}, {0, NULL}};
static CV_PossibleValue_t playertwo_cons_t[] = {{0, "Off"}, {1, "On"}, {0, NULL}};

static CV_PossibleValue_t teams_cons_t[] = {{0, "Off"}, {1, "On"}, {0, NULL}};
static CV_PossibleValue_t triggerteams_cons_t[] = {{0, "Off"}, {1, "On"}, {0, NULL}};
...
static CV_PossibleValue_t stocklives_cons_t[] = {{1, "MIN"}, {99, "MAX"}, {0, NULL}};
consvar_t cv_stocklives = {"num_stocklives", "3", CV_NETVAR, stocklives_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};

static CV_PossibleValue_t hudoption_cons_t[] = {{1, "MIN"}, {2, "MAX"}, {0, NULL}};
consvar_t cv_hudoption = {"hud_option", "1", CV_SAVE, hudoption_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
...
consvar_t cv_theovertime =      {"theovertimee",      "0", CV_NETVAR, theovertime_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_victory =      {"victoryy",      "0", CV_NETVAR, victory_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_timeup =      {"timeupp",      "0", CV_NETVAR, timeup_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_addplayertwo =      {"playertwo",      "0", CV_NETVAR, playertwo_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};

consvar_t cv_triggerteams =      {"teams",      "0", CV_NETVAR, triggerteams_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_teams =      {"triggerteams",      "0", CV_NETVAR, teams_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};

consvar_t cv_recycler =      {"Bomb",      "6", CV_NETVAR, chances_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_teleporters =   {"Hamburger",    "4", CV_NETVAR, chances_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_superring =     {"Pumpkin",     "3", CV_NETVAR, chances_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_supersneakers = {"Spikeball",  "5", CV_NETVAR, chances_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_invincibility = {"Mine", "6", CV_NETVAR, chances_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_jumpshield =    {"Heart",    "2", CV_NETVAR, chances_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_watershield =   {"Crate",   "5", CV_NETVAR, chances_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_ringshield =    {"SuperEmerald",    "1", CV_NETVAR, chances_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_forceshield =   {"CrateNothing",   "5", CV_NETVAR, chances_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_arecycler =      {"CrateBomb",      "6", CV_NETVAR, chances_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_ateleporters =   {"CrateHamburger",    "4", CV_NETVAR, chances_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_asuperring =     {"CratePumpkin",     "3", CV_NETVAR, chances_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_asupersneakers = {"CrateSpikeball",  "5", CV_NETVAR, chances_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_ainvincibility = {"CrateMine", "6", CV_NETVAR, chances_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_ajumpshield =    {"CrateHeart",    "2", CV_NETVAR, chances_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_aringshield =    {"CrateSuperEmerald",    "1", CV_NETVAR, chances_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_bombshield =    {"freeslot",    "5", CV_NETVAR, chances_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_1up =           {"freeslott",           "5", CV_NETVAR, chances_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_eggmanbox =     {"freeslottt",        "5", CV_NETVAR, chances_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
...
consvar_t cv_teamscramble = {"teamscramble", "Off", CV_NETVAR|CV_CALL|CV_NOINIT, teamscramble_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
...
consvar_t cv_overtime = {"sudden_death", "Yes", CV_NETVAR, CV_YesNo, NULL, 0, NULL, NULL, 0, 0, NULL};
...
static CV_PossibleValue_t pointlimit_cons_t[] = {{0, "MIN"}, {99, "MAX"}, {0, NULL}};
consvar_t cv_pointlimit = {"pointlimit", "3", CV_NETVAR|CV_CALL|CV_NOINIT, pointlimit_cons_t,
...
void D_RegisterServerCommands(void)
{
	...
	CV_RegisterVar(&cv_theovertime);
	CV_RegisterVar(&cv_victory);
	CV_RegisterVar(&cv_timeup);
	CV_RegisterVar(&cv_addplayertwo);
	
	CV_RegisterVar(&cv_teams);
	CV_RegisterVar(&cv_triggerteams);
	...
	CV_RegisterVar(&cv_arecycler);
	CV_RegisterVar(&cv_ateleporters);
	CV_RegisterVar(&cv_asuperring);
	CV_RegisterVar(&cv_asupersneakers);
	CV_RegisterVar(&cv_ainvincibility);
	CV_RegisterVar(&cv_ajumpshield);
	CV_RegisterVar(&cv_aringshield);
	...
	CV_RegisterVar(&cv_stocklives);
	CV_RegisterVar(&cv_hudoption);
...
{
	SendNameAndColor();
	if (splitscreen || botingame || cv_addplayertwo.value == 1)
		SendNameAndColor2();
	SendWeaponPref();
	if (splitscreen || cv_addplayertwo.value == 1)
		SendWeaponPref2();
}
...
void D_MapChange(INT32 mapnum, INT32 newgametype, boolean pultmode, boolean resetplayers, INT32 delay, boolean skipprecutscene, boolean FLS)
{
	...
	if (cv_setgamemodebefore.value == 1 && cv_dummyscramble.value == 0)
	{
	   CONS_Printf(M_GetText("Gamemode was changed from Points to Stock.\n"));
	   CV_SetValue(&cv_dummyscramble, 1);
	}
	   
	else if (cv_setgamemodebefore.value == 0 && cv_dummyscramble.value == 1)
	{
	   CONS_Printf(M_GetText("Gamemode was changed from Stock to Points.\n"));
	   CV_SetValue(&cv_dummyscramble, 0);
	}
	
	if (cv_triggerteams.value == 1 && cv_teams.value == 0)
	{
	   CONS_Printf(M_GetText("Teams are now ON.\n"));
	   CV_SetValue(&cv_teams, 1);
	}
	   
	else if (cv_triggerteams.value == 0 && cv_teams.value == 1)
	{
	   CONS_Printf(M_GetText("Teams are now OFF.\n"));
	   CV_SetValue(&cv_teams, 0);
	}
	
	CV_SetValue(&cv_victory, 0);
	CV_SetValue(&cv_timeup, 0);
	CV_SetValue(&cv_theovertime, 0);
...
static void Got_Mapcmd(UINT8 **cp, INT32 playernum)
{
	...
	if (!skipprecutscene)
	{
		...
		CONS_Printf(M_GetText("Now Loading...\n"));
	}
...
static void Command_Teamchange_f(void)
{
	...
	{
		if (!strcasecmp(COM_Argv(1), "playing") || !strcasecmp(COM_Argv(1), "1"))
...
static void PointLimit_OnChange(void)
{
	...
	if (server && Playing() && gametype == GT_COOP)
	{
...
static void TimeLimit_OnChange(void)
{
	...
	if (server && Playing() && cv_timelimit.value != 0 && gametype == GT_COOP)
	{
	...
	if (cv_timelimit.value != 0)
	{
		...
		timelimitintics = cv_timelimit.value * 64 * TICRATE;
